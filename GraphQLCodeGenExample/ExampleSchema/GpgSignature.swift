...
extension ExampleSchema {
	open class GpgSignatureQuery: GraphQL.AbstractQuery, GraphQLQuery {
		public typealias Response = GpgSignature

		@discardableResult
		open func email(aliasSuffix: String? = nil) -> GpgSignatureQuery {
			addField(field: "email", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func isValid(aliasSuffix: String? = nil) -> GpgSignatureQuery {
			addField(field: "isValid", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func keyId(aliasSuffix: String? = nil) -> GpgSignatureQuery {
			addField(field: "keyId", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func payload(aliasSuffix: String? = nil) -> GpgSignatureQuery {
			addField(field: "payload", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func signature(aliasSuffix: String? = nil) -> GpgSignatureQuery {
			addField(field: "signature", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func signer(aliasSuffix: String? = nil, _ subfields: (UserQuery) -> Void) -> GpgSignatureQuery {
		...
		@discardableResult
		open func state(aliasSuffix: String? = nil) -> GpgSignatureQuery {
			addField(field: "state", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func wasSignedByGitHub(aliasSuffix: String? = nil) -> GpgSignatureQuery {
			addField(field: "wasSignedByGitHub", aliasSuffix: aliasSuffix)
			return self
		}
	}

	open class GpgSignature: GraphQL.AbstractResponse, GraphQLObject, GitSignature {
		public typealias Query = GpgSignatureQuery
		...
		open override func deserializeValue(fieldName: String, value: Any) throws -> Any? {
			...
			switch fieldName {
				...
				guard let value = value as? String else {
					throw SchemaViolationError(type: GpgSignature.self, field: fieldName, value: fieldValue)
				}
				return value
		...
		open var typeName: String { return "GpgSignature" }
		...
		open var keyId: String? {
			return internalGetKeyId()
		}

		func internalGetKeyId(aliasSuffix: String? = nil) -> String? {
			return field(field: "keyId", aliasSuffix: aliasSuffix) as! String?
		}
