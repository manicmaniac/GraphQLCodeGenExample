...
extension ExampleSchema {
	open class OrgUpdateMemberRepositoryInvitationPermissionAuditEntryQuery: GraphQL.AbstractQuery, GraphQLQuery {
		public typealias Response = OrgUpdateMemberRepositoryInvitationPermissionAuditEntry

		@discardableResult
		open func action(aliasSuffix: String? = nil) -> OrgUpdateMemberRepositoryInvitationPermissionAuditEntryQuery {
			addField(field: "action", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func actor(aliasSuffix: String? = nil, _ subfields: (AuditEntryActorQuery) -> Void) -> OrgUpdateMemberRepositoryInvitationPermissionAuditEntryQuery {
		...
		@discardableResult
		open func actorIp(aliasSuffix: String? = nil) -> OrgUpdateMemberRepositoryInvitationPermissionAuditEntryQuery {
			addField(field: "actorIp", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func actorLocation(aliasSuffix: String? = nil, _ subfields: (ActorLocationQuery) -> Void) -> OrgUpdateMemberRepositoryInvitationPermissionAuditEntryQuery {
		...
		@discardableResult
		open func actorLogin(aliasSuffix: String? = nil) -> OrgUpdateMemberRepositoryInvitationPermissionAuditEntryQuery {
			addField(field: "actorLogin", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func actorResourcePath(aliasSuffix: String? = nil) -> OrgUpdateMemberRepositoryInvitationPermissionAuditEntryQuery {
			addField(field: "actorResourcePath", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func actorUrl(aliasSuffix: String? = nil) -> OrgUpdateMemberRepositoryInvitationPermissionAuditEntryQuery {
			addField(field: "actorUrl", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func canInviteOutsideCollaboratorsToRepositories(aliasSuffix: String? = nil) -> OrgUpdateMemberRepositoryInvitationPermissionAuditEntryQuery {
			addField(field: "canInviteOutsideCollaboratorsToRepositories", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func createdAt(aliasSuffix: String? = nil) -> OrgUpdateMemberRepositoryInvitationPermissionAuditEntryQuery {
			addField(field: "createdAt", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func id(aliasSuffix: String? = nil) -> OrgUpdateMemberRepositoryInvitationPermissionAuditEntryQuery {
			addField(field: "id", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func operationType(aliasSuffix: String? = nil) -> OrgUpdateMemberRepositoryInvitationPermissionAuditEntryQuery {
			addField(field: "operationType", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func organization(aliasSuffix: String? = nil, _ subfields: (OrganizationQuery) -> Void) -> OrgUpdateMemberRepositoryInvitationPermissionAuditEntryQuery {
		...
		@discardableResult
		open func organizationName(aliasSuffix: String? = nil) -> OrgUpdateMemberRepositoryInvitationPermissionAuditEntryQuery {
			addField(field: "organizationName", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func organizationResourcePath(aliasSuffix: String? = nil) -> OrgUpdateMemberRepositoryInvitationPermissionAuditEntryQuery {
			addField(field: "organizationResourcePath", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func organizationUrl(aliasSuffix: String? = nil) -> OrgUpdateMemberRepositoryInvitationPermissionAuditEntryQuery {
			addField(field: "organizationUrl", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func user(aliasSuffix: String? = nil, _ subfields: (UserQuery) -> Void) -> OrgUpdateMemberRepositoryInvitationPermissionAuditEntryQuery {
		...
		@discardableResult
		open func userLogin(aliasSuffix: String? = nil) -> OrgUpdateMemberRepositoryInvitationPermissionAuditEntryQuery {
			addField(field: "userLogin", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func userResourcePath(aliasSuffix: String? = nil) -> OrgUpdateMemberRepositoryInvitationPermissionAuditEntryQuery {
			addField(field: "userResourcePath", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func userUrl(aliasSuffix: String? = nil) -> OrgUpdateMemberRepositoryInvitationPermissionAuditEntryQuery {
			addField(field: "userUrl", aliasSuffix: aliasSuffix)
			return self
		}
	}

	open class OrgUpdateMemberRepositoryInvitationPermissionAuditEntry: GraphQL.AbstractResponse, GraphQLObject, AuditEntry, Node, OrganizationAuditEntry, OrganizationAuditEntryData {
		public typealias Query = OrgUpdateMemberRepositoryInvitationPermissionAuditEntryQuery
		...
		open override func deserializeValue(fieldName: String, value: Any) throws -> Any? {
			...
			switch fieldName {
				...
				guard let value = value as? String else {
					throw SchemaViolationError(type: OrgUpdateMemberRepositoryInvitationPermissionAuditEntry.self, field: fieldName, value: fieldValue)
				}
				return value
				...
				case "canInviteOutsideCollaboratorsToRepositories":
				if value is NSNull { return nil }
		...
		open var typeName: String { return "OrgUpdateMemberRepositoryInvitationPermissionAuditEntry" }
		...
		open var canInviteOutsideCollaboratorsToRepositories: Bool? {
			return internalGetCanInviteOutsideCollaboratorsToRepositories()
		}

		func internalGetCanInviteOutsideCollaboratorsToRepositories(aliasSuffix: String? = nil) -> Bool? {
			return field(field: "canInviteOutsideCollaboratorsToRepositories", aliasSuffix: aliasSuffix) as! Bool?
		}
