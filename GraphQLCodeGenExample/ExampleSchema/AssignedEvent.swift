...
extension ExampleSchema {
	open class AssignedEventQuery: GraphQL.AbstractQuery, GraphQLQuery {
		public typealias Response = AssignedEvent

		@discardableResult
		open func actor(aliasSuffix: String? = nil, _ subfields: (ActorQuery) -> Void) -> AssignedEventQuery {
		...
		@discardableResult
		open func assignable(aliasSuffix: String? = nil, _ subfields: (AssignableQuery) -> Void) -> AssignedEventQuery {
		...
		@discardableResult
		open func assignee(aliasSuffix: String? = nil, _ subfields: (AssigneeQuery) -> Void) -> AssignedEventQuery {
		...
		@discardableResult
		open func createdAt(aliasSuffix: String? = nil) -> AssignedEventQuery {
			addField(field: "createdAt", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func id(aliasSuffix: String? = nil) -> AssignedEventQuery {
		...
		@discardableResult
		open func user(aliasSuffix: String? = nil, _ subfields: (UserQuery) -> Void) -> AssignedEventQuery {
	...
	open class AssignedEvent: GraphQL.AbstractResponse, GraphQLObject, IssueTimelineItem, IssueTimelineItems, Node, PullRequestTimelineItem, PullRequestTimelineItems {
		public typealias Query = AssignedEventQuery
		...
		open override func deserializeValue(fieldName: String, value: Any) throws -> Any? {
			...
			switch fieldName {
				...
				guard let value = value as? [String: Any] else {
					throw SchemaViolationError(type: AssignedEvent.self, field: fieldName, value: fieldValue)
				}
		...
		open var typeName: String { return "AssignedEvent" }
