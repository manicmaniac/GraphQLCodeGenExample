...
extension ExampleSchema {
	open class ReviewRequestRemovedEventQuery: GraphQL.AbstractQuery, GraphQLQuery {
		public typealias Response = ReviewRequestRemovedEvent

		@discardableResult
		open func actor(aliasSuffix: String? = nil, _ subfields: (ActorQuery) -> Void) -> ReviewRequestRemovedEventQuery {
		...
		@discardableResult
		open func createdAt(aliasSuffix: String? = nil) -> ReviewRequestRemovedEventQuery {
			addField(field: "createdAt", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func id(aliasSuffix: String? = nil) -> ReviewRequestRemovedEventQuery {
			addField(field: "id", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func pullRequest(aliasSuffix: String? = nil, _ subfields: (PullRequestQuery) -> Void) -> ReviewRequestRemovedEventQuery {
		...
		@discardableResult
		open func requestedReviewer(aliasSuffix: String? = nil, _ subfields: (RequestedReviewerQuery) -> Void) -> ReviewRequestRemovedEventQuery {
	...
	open class ReviewRequestRemovedEvent: GraphQL.AbstractResponse, GraphQLObject, Node, PullRequestTimelineItem, PullRequestTimelineItems {
		public typealias Query = ReviewRequestRemovedEventQuery
		...
		open override func deserializeValue(fieldName: String, value: Any) throws -> Any? {
			...
			switch fieldName {
				...
				guard let value = value as? [String: Any] else {
					throw SchemaViolationError(type: ReviewRequestRemovedEvent.self, field: fieldName, value: fieldValue)
				}
		...
		open var typeName: String { return "ReviewRequestRemovedEvent" }
