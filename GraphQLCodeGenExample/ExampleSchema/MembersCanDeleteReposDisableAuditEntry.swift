...
extension ExampleSchema {
	open class MembersCanDeleteReposDisableAuditEntryQuery: GraphQL.AbstractQuery, GraphQLQuery {
		public typealias Response = MembersCanDeleteReposDisableAuditEntry

		@discardableResult
		open func action(aliasSuffix: String? = nil) -> MembersCanDeleteReposDisableAuditEntryQuery {
			addField(field: "action", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func actor(aliasSuffix: String? = nil, _ subfields: (AuditEntryActorQuery) -> Void) -> MembersCanDeleteReposDisableAuditEntryQuery {
		...
		@discardableResult
		open func actorIp(aliasSuffix: String? = nil) -> MembersCanDeleteReposDisableAuditEntryQuery {
			addField(field: "actorIp", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func actorLocation(aliasSuffix: String? = nil, _ subfields: (ActorLocationQuery) -> Void) -> MembersCanDeleteReposDisableAuditEntryQuery {
		...
		@discardableResult
		open func actorLogin(aliasSuffix: String? = nil) -> MembersCanDeleteReposDisableAuditEntryQuery {
			addField(field: "actorLogin", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func actorResourcePath(aliasSuffix: String? = nil) -> MembersCanDeleteReposDisableAuditEntryQuery {
			addField(field: "actorResourcePath", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func actorUrl(aliasSuffix: String? = nil) -> MembersCanDeleteReposDisableAuditEntryQuery {
			addField(field: "actorUrl", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func createdAt(aliasSuffix: String? = nil) -> MembersCanDeleteReposDisableAuditEntryQuery {
			addField(field: "createdAt", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func enterpriseResourcePath(aliasSuffix: String? = nil) -> MembersCanDeleteReposDisableAuditEntryQuery {
			addField(field: "enterpriseResourcePath", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func enterpriseSlug(aliasSuffix: String? = nil) -> MembersCanDeleteReposDisableAuditEntryQuery {
			addField(field: "enterpriseSlug", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func enterpriseUrl(aliasSuffix: String? = nil) -> MembersCanDeleteReposDisableAuditEntryQuery {
			addField(field: "enterpriseUrl", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func id(aliasSuffix: String? = nil) -> MembersCanDeleteReposDisableAuditEntryQuery {
			addField(field: "id", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func operationType(aliasSuffix: String? = nil) -> MembersCanDeleteReposDisableAuditEntryQuery {
			addField(field: "operationType", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func organization(aliasSuffix: String? = nil, _ subfields: (OrganizationQuery) -> Void) -> MembersCanDeleteReposDisableAuditEntryQuery {
		...
		@discardableResult
		open func organizationName(aliasSuffix: String? = nil) -> MembersCanDeleteReposDisableAuditEntryQuery {
			addField(field: "organizationName", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func organizationResourcePath(aliasSuffix: String? = nil) -> MembersCanDeleteReposDisableAuditEntryQuery {
			addField(field: "organizationResourcePath", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func organizationUrl(aliasSuffix: String? = nil) -> MembersCanDeleteReposDisableAuditEntryQuery {
			addField(field: "organizationUrl", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func user(aliasSuffix: String? = nil, _ subfields: (UserQuery) -> Void) -> MembersCanDeleteReposDisableAuditEntryQuery {
		...
		@discardableResult
		open func userLogin(aliasSuffix: String? = nil) -> MembersCanDeleteReposDisableAuditEntryQuery {
			addField(field: "userLogin", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func userResourcePath(aliasSuffix: String? = nil) -> MembersCanDeleteReposDisableAuditEntryQuery {
			addField(field: "userResourcePath", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func userUrl(aliasSuffix: String? = nil) -> MembersCanDeleteReposDisableAuditEntryQuery {
			addField(field: "userUrl", aliasSuffix: aliasSuffix)
			return self
		}
	}

	open class MembersCanDeleteReposDisableAuditEntry: GraphQL.AbstractResponse, GraphQLObject, AuditEntry, EnterpriseAuditEntryData, Node, OrganizationAuditEntry, OrganizationAuditEntryData {
		public typealias Query = MembersCanDeleteReposDisableAuditEntryQuery
		...
		open override func deserializeValue(fieldName: String, value: Any) throws -> Any? {
			...
			switch fieldName {
				...
				guard let value = value as? String else {
					throw SchemaViolationError(type: MembersCanDeleteReposDisableAuditEntry.self, field: fieldName, value: fieldValue)
				}
				return value
		...
		open var typeName: String { return "MembersCanDeleteReposDisableAuditEntry" }
