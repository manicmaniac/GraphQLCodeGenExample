...
extension ExampleSchema {
	open class MembersCanDeleteReposClearAuditEntryQuery: GraphQL.AbstractQuery, GraphQLQuery {
		public typealias Response = MembersCanDeleteReposClearAuditEntry

		@discardableResult
		open func action(aliasSuffix: String? = nil) -> MembersCanDeleteReposClearAuditEntryQuery {
			addField(field: "action", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func actor(aliasSuffix: String? = nil, _ subfields: (AuditEntryActorQuery) -> Void) -> MembersCanDeleteReposClearAuditEntryQuery {
		...
		@discardableResult
		open func actorIp(aliasSuffix: String? = nil) -> MembersCanDeleteReposClearAuditEntryQuery {
			addField(field: "actorIp", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func actorLocation(aliasSuffix: String? = nil, _ subfields: (ActorLocationQuery) -> Void) -> MembersCanDeleteReposClearAuditEntryQuery {
		...
		@discardableResult
		open func actorLogin(aliasSuffix: String? = nil) -> MembersCanDeleteReposClearAuditEntryQuery {
			addField(field: "actorLogin", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func actorResourcePath(aliasSuffix: String? = nil) -> MembersCanDeleteReposClearAuditEntryQuery {
			addField(field: "actorResourcePath", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func actorUrl(aliasSuffix: String? = nil) -> MembersCanDeleteReposClearAuditEntryQuery {
			addField(field: "actorUrl", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func createdAt(aliasSuffix: String? = nil) -> MembersCanDeleteReposClearAuditEntryQuery {
			addField(field: "createdAt", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func enterpriseResourcePath(aliasSuffix: String? = nil) -> MembersCanDeleteReposClearAuditEntryQuery {
			addField(field: "enterpriseResourcePath", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func enterpriseSlug(aliasSuffix: String? = nil) -> MembersCanDeleteReposClearAuditEntryQuery {
			addField(field: "enterpriseSlug", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func enterpriseUrl(aliasSuffix: String? = nil) -> MembersCanDeleteReposClearAuditEntryQuery {
			addField(field: "enterpriseUrl", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func id(aliasSuffix: String? = nil) -> MembersCanDeleteReposClearAuditEntryQuery {
			addField(field: "id", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func operationType(aliasSuffix: String? = nil) -> MembersCanDeleteReposClearAuditEntryQuery {
			addField(field: "operationType", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func organization(aliasSuffix: String? = nil, _ subfields: (OrganizationQuery) -> Void) -> MembersCanDeleteReposClearAuditEntryQuery {
		...
		@discardableResult
		open func organizationName(aliasSuffix: String? = nil) -> MembersCanDeleteReposClearAuditEntryQuery {
			addField(field: "organizationName", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func organizationResourcePath(aliasSuffix: String? = nil) -> MembersCanDeleteReposClearAuditEntryQuery {
			addField(field: "organizationResourcePath", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func organizationUrl(aliasSuffix: String? = nil) -> MembersCanDeleteReposClearAuditEntryQuery {
			addField(field: "organizationUrl", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func user(aliasSuffix: String? = nil, _ subfields: (UserQuery) -> Void) -> MembersCanDeleteReposClearAuditEntryQuery {
		...
		@discardableResult
		open func userLogin(aliasSuffix: String? = nil) -> MembersCanDeleteReposClearAuditEntryQuery {
			addField(field: "userLogin", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func userResourcePath(aliasSuffix: String? = nil) -> MembersCanDeleteReposClearAuditEntryQuery {
			addField(field: "userResourcePath", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func userUrl(aliasSuffix: String? = nil) -> MembersCanDeleteReposClearAuditEntryQuery {
			addField(field: "userUrl", aliasSuffix: aliasSuffix)
			return self
		}
	}

	open class MembersCanDeleteReposClearAuditEntry: GraphQL.AbstractResponse, GraphQLObject, AuditEntry, EnterpriseAuditEntryData, Node, OrganizationAuditEntry, OrganizationAuditEntryData {
		public typealias Query = MembersCanDeleteReposClearAuditEntryQuery
		...
		open override func deserializeValue(fieldName: String, value: Any) throws -> Any? {
			...
			switch fieldName {
				...
				guard let value = value as? String else {
					throw SchemaViolationError(type: MembersCanDeleteReposClearAuditEntry.self, field: fieldName, value: fieldValue)
				}
				return value
		...
		open var typeName: String { return "MembersCanDeleteReposClearAuditEntry" }
