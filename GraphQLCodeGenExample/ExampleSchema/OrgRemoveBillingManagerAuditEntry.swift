...
extension ExampleSchema {
	open class OrgRemoveBillingManagerAuditEntryQuery: GraphQL.AbstractQuery, GraphQLQuery {
		public typealias Response = OrgRemoveBillingManagerAuditEntry

		@discardableResult
		open func action(aliasSuffix: String? = nil) -> OrgRemoveBillingManagerAuditEntryQuery {
			addField(field: "action", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func actor(aliasSuffix: String? = nil, _ subfields: (AuditEntryActorQuery) -> Void) -> OrgRemoveBillingManagerAuditEntryQuery {
		...
		@discardableResult
		open func actorIp(aliasSuffix: String? = nil) -> OrgRemoveBillingManagerAuditEntryQuery {
			addField(field: "actorIp", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func actorLocation(aliasSuffix: String? = nil, _ subfields: (ActorLocationQuery) -> Void) -> OrgRemoveBillingManagerAuditEntryQuery {
		...
		@discardableResult
		open func actorLogin(aliasSuffix: String? = nil) -> OrgRemoveBillingManagerAuditEntryQuery {
			addField(field: "actorLogin", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func actorResourcePath(aliasSuffix: String? = nil) -> OrgRemoveBillingManagerAuditEntryQuery {
			addField(field: "actorResourcePath", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func actorUrl(aliasSuffix: String? = nil) -> OrgRemoveBillingManagerAuditEntryQuery {
			addField(field: "actorUrl", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func createdAt(aliasSuffix: String? = nil) -> OrgRemoveBillingManagerAuditEntryQuery {
			addField(field: "createdAt", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func id(aliasSuffix: String? = nil) -> OrgRemoveBillingManagerAuditEntryQuery {
			addField(field: "id", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func operationType(aliasSuffix: String? = nil) -> OrgRemoveBillingManagerAuditEntryQuery {
			addField(field: "operationType", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func organization(aliasSuffix: String? = nil, _ subfields: (OrganizationQuery) -> Void) -> OrgRemoveBillingManagerAuditEntryQuery {
		...
		@discardableResult
		open func organizationName(aliasSuffix: String? = nil) -> OrgRemoveBillingManagerAuditEntryQuery {
			addField(field: "organizationName", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func organizationResourcePath(aliasSuffix: String? = nil) -> OrgRemoveBillingManagerAuditEntryQuery {
			addField(field: "organizationResourcePath", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func organizationUrl(aliasSuffix: String? = nil) -> OrgRemoveBillingManagerAuditEntryQuery {
			addField(field: "organizationUrl", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func reason(aliasSuffix: String? = nil) -> OrgRemoveBillingManagerAuditEntryQuery {
			addField(field: "reason", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func user(aliasSuffix: String? = nil, _ subfields: (UserQuery) -> Void) -> OrgRemoveBillingManagerAuditEntryQuery {
		...
		@discardableResult
		open func userLogin(aliasSuffix: String? = nil) -> OrgRemoveBillingManagerAuditEntryQuery {
			addField(field: "userLogin", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func userResourcePath(aliasSuffix: String? = nil) -> OrgRemoveBillingManagerAuditEntryQuery {
			addField(field: "userResourcePath", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func userUrl(aliasSuffix: String? = nil) -> OrgRemoveBillingManagerAuditEntryQuery {
			addField(field: "userUrl", aliasSuffix: aliasSuffix)
			return self
		}
	}

	open class OrgRemoveBillingManagerAuditEntry: GraphQL.AbstractResponse, GraphQLObject, AuditEntry, Node, OrganizationAuditEntry, OrganizationAuditEntryData {
		public typealias Query = OrgRemoveBillingManagerAuditEntryQuery
		...
		open override func deserializeValue(fieldName: String, value: Any) throws -> Any? {
			...
			switch fieldName {
				...
				guard let value = value as? String else {
					throw SchemaViolationError(type: OrgRemoveBillingManagerAuditEntry.self, field: fieldName, value: fieldValue)
				}
				return value
				...
				return OrgRemoveBillingManagerAuditEntryReason(rawValue: value) ?? .unknownValue
		...
		open var typeName: String { return "OrgRemoveBillingManagerAuditEntry" }
		...
		open var reason: ExampleSchema.OrgRemoveBillingManagerAuditEntryReason? {
			return internalGetReason()
		}

		func internalGetReason(aliasSuffix: String? = nil) -> ExampleSchema.OrgRemoveBillingManagerAuditEntryReason? {
			return field(field: "reason", aliasSuffix: aliasSuffix) as! ExampleSchema.OrgRemoveBillingManagerAuditEntryReason?
		}
