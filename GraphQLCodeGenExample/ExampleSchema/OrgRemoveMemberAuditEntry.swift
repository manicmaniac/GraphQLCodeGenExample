...
extension ExampleSchema {
	open class OrgRemoveMemberAuditEntryQuery: GraphQL.AbstractQuery, GraphQLQuery {
		public typealias Response = OrgRemoveMemberAuditEntry

		@discardableResult
		open func action(aliasSuffix: String? = nil) -> OrgRemoveMemberAuditEntryQuery {
			addField(field: "action", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func actor(aliasSuffix: String? = nil, _ subfields: (AuditEntryActorQuery) -> Void) -> OrgRemoveMemberAuditEntryQuery {
		...
		@discardableResult
		open func actorIp(aliasSuffix: String? = nil) -> OrgRemoveMemberAuditEntryQuery {
			addField(field: "actorIp", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func actorLocation(aliasSuffix: String? = nil, _ subfields: (ActorLocationQuery) -> Void) -> OrgRemoveMemberAuditEntryQuery {
		...
		@discardableResult
		open func actorLogin(aliasSuffix: String? = nil) -> OrgRemoveMemberAuditEntryQuery {
			addField(field: "actorLogin", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func actorResourcePath(aliasSuffix: String? = nil) -> OrgRemoveMemberAuditEntryQuery {
			addField(field: "actorResourcePath", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func actorUrl(aliasSuffix: String? = nil) -> OrgRemoveMemberAuditEntryQuery {
			addField(field: "actorUrl", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func createdAt(aliasSuffix: String? = nil) -> OrgRemoveMemberAuditEntryQuery {
			addField(field: "createdAt", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func id(aliasSuffix: String? = nil) -> OrgRemoveMemberAuditEntryQuery {
			addField(field: "id", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func membershipTypes(aliasSuffix: String? = nil) -> OrgRemoveMemberAuditEntryQuery {
			addField(field: "membershipTypes", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func operationType(aliasSuffix: String? = nil) -> OrgRemoveMemberAuditEntryQuery {
			addField(field: "operationType", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func organization(aliasSuffix: String? = nil, _ subfields: (OrganizationQuery) -> Void) -> OrgRemoveMemberAuditEntryQuery {
		...
		@discardableResult
		open func organizationName(aliasSuffix: String? = nil) -> OrgRemoveMemberAuditEntryQuery {
			addField(field: "organizationName", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func organizationResourcePath(aliasSuffix: String? = nil) -> OrgRemoveMemberAuditEntryQuery {
			addField(field: "organizationResourcePath", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func organizationUrl(aliasSuffix: String? = nil) -> OrgRemoveMemberAuditEntryQuery {
			addField(field: "organizationUrl", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func reason(aliasSuffix: String? = nil) -> OrgRemoveMemberAuditEntryQuery {
			addField(field: "reason", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func user(aliasSuffix: String? = nil, _ subfields: (UserQuery) -> Void) -> OrgRemoveMemberAuditEntryQuery {
		...
		@discardableResult
		open func userLogin(aliasSuffix: String? = nil) -> OrgRemoveMemberAuditEntryQuery {
			addField(field: "userLogin", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func userResourcePath(aliasSuffix: String? = nil) -> OrgRemoveMemberAuditEntryQuery {
			addField(field: "userResourcePath", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func userUrl(aliasSuffix: String? = nil) -> OrgRemoveMemberAuditEntryQuery {
			addField(field: "userUrl", aliasSuffix: aliasSuffix)
			return self
		}
	}

	open class OrgRemoveMemberAuditEntry: GraphQL.AbstractResponse, GraphQLObject, AuditEntry, Node, OrganizationAuditEntry, OrganizationAuditEntryData {
		public typealias Query = OrgRemoveMemberAuditEntryQuery
		...
		open override func deserializeValue(fieldName: String, value: Any) throws -> Any? {
			...
			switch fieldName {
				...
				guard let value = value as? String else {
					throw SchemaViolationError(type: OrgRemoveMemberAuditEntry.self, field: fieldName, value: fieldValue)
				}
				return value
				...
				return value.map { return OrgRemoveMemberAuditEntryMembershipType(rawValue: $0) ?? .unknownValue }
				...
				return OrgRemoveMemberAuditEntryReason(rawValue: value) ?? .unknownValue
		...
		open var typeName: String { return "OrgRemoveMemberAuditEntry" }
		...
		open var membershipTypes: [ExampleSchema.OrgRemoveMemberAuditEntryMembershipType]? {
			return internalGetMembershipTypes()
		}

		func internalGetMembershipTypes(aliasSuffix: String? = nil) -> [ExampleSchema.OrgRemoveMemberAuditEntryMembershipType]? {
			return field(field: "membershipTypes", aliasSuffix: aliasSuffix) as! [ExampleSchema.OrgRemoveMemberAuditEntryMembershipType]?
		}
		...
		open var reason: ExampleSchema.OrgRemoveMemberAuditEntryReason? {
			return internalGetReason()
		}

		func internalGetReason(aliasSuffix: String? = nil) -> ExampleSchema.OrgRemoveMemberAuditEntryReason? {
			return field(field: "reason", aliasSuffix: aliasSuffix) as! ExampleSchema.OrgRemoveMemberAuditEntryReason?
		}
