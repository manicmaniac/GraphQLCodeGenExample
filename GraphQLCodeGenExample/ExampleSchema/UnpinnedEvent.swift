...
extension ExampleSchema {
	open class UnpinnedEventQuery: GraphQL.AbstractQuery, GraphQLQuery {
		public typealias Response = UnpinnedEvent

		@discardableResult
		open func actor(aliasSuffix: String? = nil, _ subfields: (ActorQuery) -> Void) -> UnpinnedEventQuery {
		...
		@discardableResult
		open func createdAt(aliasSuffix: String? = nil) -> UnpinnedEventQuery {
			addField(field: "createdAt", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func id(aliasSuffix: String? = nil) -> UnpinnedEventQuery {
			addField(field: "id", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func issue(aliasSuffix: String? = nil, _ subfields: (IssueQuery) -> Void) -> UnpinnedEventQuery {
	...
	open class UnpinnedEvent: GraphQL.AbstractResponse, GraphQLObject, IssueTimelineItems, Node, PullRequestTimelineItems {
		public typealias Query = UnpinnedEventQuery
		...
		open override func deserializeValue(fieldName: String, value: Any) throws -> Any? {
			...
			switch fieldName {
				...
				guard let value = value as? [String: Any] else {
					throw SchemaViolationError(type: UnpinnedEvent.self, field: fieldName, value: fieldValue)
				}
		...
		open var typeName: String { return "UnpinnedEvent" }
