...
extension ExampleSchema {
	open class CommitHistoryConnectionQuery: GraphQL.AbstractQuery, GraphQLQuery {
		public typealias Response = CommitHistoryConnection

		@discardableResult
		open func edges(aliasSuffix: String? = nil, _ subfields: (CommitEdgeQuery) -> Void) -> CommitHistoryConnectionQuery {
		...
		@discardableResult
		open func nodes(aliasSuffix: String? = nil, _ subfields: (CommitQuery) -> Void) -> CommitHistoryConnectionQuery {
		...
		@discardableResult
		open func pageInfo(aliasSuffix: String? = nil, _ subfields: (PageInfoQuery) -> Void) -> CommitHistoryConnectionQuery {
		...
		@discardableResult
		open func totalCount(aliasSuffix: String? = nil) -> CommitHistoryConnectionQuery {
			addField(field: "totalCount", aliasSuffix: aliasSuffix)
			return self
		}
	}

	open class CommitHistoryConnection: GraphQL.AbstractResponse, GraphQLObject {
		public typealias Query = CommitHistoryConnectionQuery
		...
		open override func deserializeValue(fieldName: String, value: Any) throws -> Any? {
			...
			switch fieldName {
				...
				guard let value = value as? [Any] else {
					throw SchemaViolationError(type: CommitHistoryConnection.self, field: fieldName, value: fieldValue)
				}
		...
		open var typeName: String { return "CommitHistoryConnection" }
