...
extension ExampleSchema {
	open class UnlabeledEventQuery: GraphQL.AbstractQuery, GraphQLQuery {
		public typealias Response = UnlabeledEvent

		@discardableResult
		open func actor(aliasSuffix: String? = nil, _ subfields: (ActorQuery) -> Void) -> UnlabeledEventQuery {
		...
		@discardableResult
		open func createdAt(aliasSuffix: String? = nil) -> UnlabeledEventQuery {
			addField(field: "createdAt", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func id(aliasSuffix: String? = nil) -> UnlabeledEventQuery {
			addField(field: "id", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func label(aliasSuffix: String? = nil, _ subfields: (LabelQuery) -> Void) -> UnlabeledEventQuery {
		...
		@discardableResult
		open func labelable(aliasSuffix: String? = nil, _ subfields: (LabelableQuery) -> Void) -> UnlabeledEventQuery {
	...
	open class UnlabeledEvent: GraphQL.AbstractResponse, GraphQLObject, IssueTimelineItem, IssueTimelineItems, Node, PullRequestTimelineItem, PullRequestTimelineItems {
		public typealias Query = UnlabeledEventQuery
		...
		open override func deserializeValue(fieldName: String, value: Any) throws -> Any? {
			...
			switch fieldName {
				...
				guard let value = value as? [String: Any] else {
					throw SchemaViolationError(type: UnlabeledEvent.self, field: fieldName, value: fieldValue)
				}
		...
		open var typeName: String { return "UnlabeledEvent" }
