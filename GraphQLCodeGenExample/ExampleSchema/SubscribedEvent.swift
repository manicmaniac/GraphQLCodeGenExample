...
extension ExampleSchema {
	open class SubscribedEventQuery: GraphQL.AbstractQuery, GraphQLQuery {
		public typealias Response = SubscribedEvent

		@discardableResult
		open func actor(aliasSuffix: String? = nil, _ subfields: (ActorQuery) -> Void) -> SubscribedEventQuery {
		...
		@discardableResult
		open func createdAt(aliasSuffix: String? = nil) -> SubscribedEventQuery {
			addField(field: "createdAt", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func id(aliasSuffix: String? = nil) -> SubscribedEventQuery {
			addField(field: "id", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func subscribable(aliasSuffix: String? = nil, _ subfields: (SubscribableQuery) -> Void) -> SubscribedEventQuery {
	...
	open class SubscribedEvent: GraphQL.AbstractResponse, GraphQLObject, IssueTimelineItem, IssueTimelineItems, Node, PullRequestTimelineItem, PullRequestTimelineItems {
		public typealias Query = SubscribedEventQuery
		...
		open override func deserializeValue(fieldName: String, value: Any) throws -> Any? {
			...
			switch fieldName {
				...
				guard let value = value as? [String: Any] else {
					throw SchemaViolationError(type: SubscribedEvent.self, field: fieldName, value: fieldValue)
				}
		...
		open var typeName: String { return "SubscribedEvent" }
