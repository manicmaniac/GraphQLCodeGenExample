...
extension ExampleSchema {
	open class TeamDiscussionCommentQuery: GraphQL.AbstractQuery, GraphQLQuery {
		public typealias Response = TeamDiscussionComment

		@discardableResult
		open func author(aliasSuffix: String? = nil, _ subfields: (ActorQuery) -> Void) -> TeamDiscussionCommentQuery {
		...
		@discardableResult
		open func authorAssociation(aliasSuffix: String? = nil) -> TeamDiscussionCommentQuery {
			addField(field: "authorAssociation", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func body(aliasSuffix: String? = nil) -> TeamDiscussionCommentQuery {
			addField(field: "body", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func bodyHtml(aliasSuffix: String? = nil) -> TeamDiscussionCommentQuery {
			addField(field: "bodyHTML", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func bodyText(aliasSuffix: String? = nil) -> TeamDiscussionCommentQuery {
			addField(field: "bodyText", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func bodyVersion(aliasSuffix: String? = nil) -> TeamDiscussionCommentQuery {
			addField(field: "bodyVersion", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func createdAt(aliasSuffix: String? = nil) -> TeamDiscussionCommentQuery {
			addField(field: "createdAt", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func createdViaEmail(aliasSuffix: String? = nil) -> TeamDiscussionCommentQuery {
			addField(field: "createdViaEmail", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func databaseId(aliasSuffix: String? = nil) -> TeamDiscussionCommentQuery {
			addField(field: "databaseId", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func discussion(aliasSuffix: String? = nil, _ subfields: (TeamDiscussionQuery) -> Void) -> TeamDiscussionCommentQuery {
			let subquery = TeamDiscussionQuery()
			subfields(subquery)

			addField(field: "discussion", aliasSuffix: aliasSuffix, subfields: subquery)
			return self
		}

		@discardableResult
		open func editor(aliasSuffix: String? = nil, _ subfields: (ActorQuery) -> Void) -> TeamDiscussionCommentQuery {
			let subquery = ActorQuery()
			subfields(subquery)
		...
		@discardableResult
		open func id(aliasSuffix: String? = nil) -> TeamDiscussionCommentQuery {
			addField(field: "id", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func includesCreatedEdit(aliasSuffix: String? = nil) -> TeamDiscussionCommentQuery {
			addField(field: "includesCreatedEdit", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func lastEditedAt(aliasSuffix: String? = nil) -> TeamDiscussionCommentQuery {
			addField(field: "lastEditedAt", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func number(aliasSuffix: String? = nil) -> TeamDiscussionCommentQuery {
			addField(field: "number", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func publishedAt(aliasSuffix: String? = nil) -> TeamDiscussionCommentQuery {
			addField(field: "publishedAt", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func reactionGroups(aliasSuffix: String? = nil, _ subfields: (ReactionGroupQuery) -> Void) -> TeamDiscussionCommentQuery {
		...
		@discardableResult
		open func reactions(aliasSuffix: String? = nil, after: String? = nil, before: String? = nil, first: Int32? = nil, last: Int32? = nil, content: ReactionContent? = nil, orderBy: ReactionOrder? = nil, _ subfields: (ReactionConnectionQuery) -> Void) -> TeamDiscussionCommentQuery {
			var args: [String] = []
		...
		@discardableResult
		open func resourcePath(aliasSuffix: String? = nil) -> TeamDiscussionCommentQuery {
			addField(field: "resourcePath", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func updatedAt(aliasSuffix: String? = nil) -> TeamDiscussionCommentQuery {
			addField(field: "updatedAt", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func url(aliasSuffix: String? = nil) -> TeamDiscussionCommentQuery {
			addField(field: "url", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func userContentEdits(aliasSuffix: String? = nil, after: String? = nil, before: String? = nil, first: Int32? = nil, last: Int32? = nil, _ subfields: (UserContentEditConnectionQuery) -> Void) -> TeamDiscussionCommentQuery {
			var args: [String] = []
		...
		@discardableResult
		open func viewerCanDelete(aliasSuffix: String? = nil) -> TeamDiscussionCommentQuery {
			addField(field: "viewerCanDelete", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func viewerCanReact(aliasSuffix: String? = nil) -> TeamDiscussionCommentQuery {
			addField(field: "viewerCanReact", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func viewerCanUpdate(aliasSuffix: String? = nil) -> TeamDiscussionCommentQuery {
			addField(field: "viewerCanUpdate", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func viewerCannotUpdateReasons(aliasSuffix: String? = nil) -> TeamDiscussionCommentQuery {
			addField(field: "viewerCannotUpdateReasons", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func viewerDidAuthor(aliasSuffix: String? = nil) -> TeamDiscussionCommentQuery {
			addField(field: "viewerDidAuthor", aliasSuffix: aliasSuffix)
			return self
		}
	}

	open class TeamDiscussionComment: GraphQL.AbstractResponse, GraphQLObject, Comment, Deletable, Node, Reactable, UniformResourceLocatable, Updatable, UpdatableComment {
		public typealias Query = TeamDiscussionCommentQuery
		...
		open override func deserializeValue(fieldName: String, value: Any) throws -> Any? {
			...
			switch fieldName {
				...
				guard let value = value as? [String: Any] else {
					throw SchemaViolationError(type: TeamDiscussionComment.self, field: fieldName, value: fieldValue)
				}
		...
		open var typeName: String { return "TeamDiscussionComment" }
		...
		open func childResponseObjectMap() -> [GraphQL.AbstractResponse]  {
			...
			objectMap.keys.forEach({
				...
				switch(key) {
					...
					case "discussion":
					response.append(internalGetDiscussion())
					response.append(contentsOf: internalGetDiscussion().childResponseObjectMap())
