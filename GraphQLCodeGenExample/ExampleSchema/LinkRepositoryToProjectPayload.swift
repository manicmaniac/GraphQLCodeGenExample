...
extension ExampleSchema {
	open class LinkRepositoryToProjectPayloadQuery: GraphQL.AbstractQuery, GraphQLQuery {
		public typealias Response = LinkRepositoryToProjectPayload

		@discardableResult
		open func clientMutationId(aliasSuffix: String? = nil) -> LinkRepositoryToProjectPayloadQuery {
			addField(field: "clientMutationId", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func project(aliasSuffix: String? = nil, _ subfields: (ProjectQuery) -> Void) -> LinkRepositoryToProjectPayloadQuery {
		...
		@discardableResult
		open func repository(aliasSuffix: String? = nil, _ subfields: (RepositoryQuery) -> Void) -> LinkRepositoryToProjectPayloadQuery {
	...
	open class LinkRepositoryToProjectPayload: GraphQL.AbstractResponse, GraphQLObject {
		public typealias Query = LinkRepositoryToProjectPayloadQuery
		...
		open override func deserializeValue(fieldName: String, value: Any) throws -> Any? {
			...
			switch fieldName {
				...
				guard let value = value as? String else {
					throw SchemaViolationError(type: LinkRepositoryToProjectPayload.self, field: fieldName, value: fieldValue)
				}
				return value
		...
		open var typeName: String { return "LinkRepositoryToProjectPayload" }
