...
extension ExampleSchema {
	open class BaseRefForcePushedEventQuery: GraphQL.AbstractQuery, GraphQLQuery {
		public typealias Response = BaseRefForcePushedEvent

		@discardableResult
		open func actor(aliasSuffix: String? = nil, _ subfields: (ActorQuery) -> Void) -> BaseRefForcePushedEventQuery {
		...
		@discardableResult
		open func afterCommit(aliasSuffix: String? = nil, _ subfields: (CommitQuery) -> Void) -> BaseRefForcePushedEventQuery {
		...
		@discardableResult
		open func beforeCommit(aliasSuffix: String? = nil, _ subfields: (CommitQuery) -> Void) -> BaseRefForcePushedEventQuery {
			let subquery = CommitQuery()
			subfields(subquery)
		...
		@discardableResult
		open func createdAt(aliasSuffix: String? = nil) -> BaseRefForcePushedEventQuery {
			addField(field: "createdAt", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func id(aliasSuffix: String? = nil) -> BaseRefForcePushedEventQuery {
			addField(field: "id", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func pullRequest(aliasSuffix: String? = nil, _ subfields: (PullRequestQuery) -> Void) -> BaseRefForcePushedEventQuery {
		...
		@discardableResult
		open func ref(aliasSuffix: String? = nil, _ subfields: (RefQuery) -> Void) -> BaseRefForcePushedEventQuery {
	...
	open class BaseRefForcePushedEvent: GraphQL.AbstractResponse, GraphQLObject, Node, PullRequestTimelineItem, PullRequestTimelineItems {
		public typealias Query = BaseRefForcePushedEventQuery
		...
		open override func deserializeValue(fieldName: String, value: Any) throws -> Any? {
			...
			switch fieldName {
				...
				guard let value = value as? [String: Any] else {
					throw SchemaViolationError(type: BaseRefForcePushedEvent.self, field: fieldName, value: fieldValue)
				}
		...
		open var typeName: String { return "BaseRefForcePushedEvent" }
