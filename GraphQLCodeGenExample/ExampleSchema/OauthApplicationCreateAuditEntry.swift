...
extension ExampleSchema {
	open class OauthApplicationCreateAuditEntryQuery: GraphQL.AbstractQuery, GraphQLQuery {
		public typealias Response = OauthApplicationCreateAuditEntry

		@discardableResult
		open func action(aliasSuffix: String? = nil) -> OauthApplicationCreateAuditEntryQuery {
			addField(field: "action", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func actor(aliasSuffix: String? = nil, _ subfields: (AuditEntryActorQuery) -> Void) -> OauthApplicationCreateAuditEntryQuery {
		...
		@discardableResult
		open func actorIp(aliasSuffix: String? = nil) -> OauthApplicationCreateAuditEntryQuery {
			addField(field: "actorIp", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func actorLocation(aliasSuffix: String? = nil, _ subfields: (ActorLocationQuery) -> Void) -> OauthApplicationCreateAuditEntryQuery {
		...
		@discardableResult
		open func actorLogin(aliasSuffix: String? = nil) -> OauthApplicationCreateAuditEntryQuery {
			addField(field: "actorLogin", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func actorResourcePath(aliasSuffix: String? = nil) -> OauthApplicationCreateAuditEntryQuery {
			addField(field: "actorResourcePath", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func actorUrl(aliasSuffix: String? = nil) -> OauthApplicationCreateAuditEntryQuery {
			addField(field: "actorUrl", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func applicationUrl(aliasSuffix: String? = nil) -> OauthApplicationCreateAuditEntryQuery {
			addField(field: "applicationUrl", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func callbackUrl(aliasSuffix: String? = nil) -> OauthApplicationCreateAuditEntryQuery {
			addField(field: "callbackUrl", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func createdAt(aliasSuffix: String? = nil) -> OauthApplicationCreateAuditEntryQuery {
			addField(field: "createdAt", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func id(aliasSuffix: String? = nil) -> OauthApplicationCreateAuditEntryQuery {
			addField(field: "id", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func oauthApplicationName(aliasSuffix: String? = nil) -> OauthApplicationCreateAuditEntryQuery {
			addField(field: "oauthApplicationName", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func oauthApplicationResourcePath(aliasSuffix: String? = nil) -> OauthApplicationCreateAuditEntryQuery {
			addField(field: "oauthApplicationResourcePath", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func oauthApplicationUrl(aliasSuffix: String? = nil) -> OauthApplicationCreateAuditEntryQuery {
			addField(field: "oauthApplicationUrl", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func operationType(aliasSuffix: String? = nil) -> OauthApplicationCreateAuditEntryQuery {
			addField(field: "operationType", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func organization(aliasSuffix: String? = nil, _ subfields: (OrganizationQuery) -> Void) -> OauthApplicationCreateAuditEntryQuery {
		...
		@discardableResult
		open func organizationName(aliasSuffix: String? = nil) -> OauthApplicationCreateAuditEntryQuery {
			addField(field: "organizationName", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func organizationResourcePath(aliasSuffix: String? = nil) -> OauthApplicationCreateAuditEntryQuery {
			addField(field: "organizationResourcePath", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func organizationUrl(aliasSuffix: String? = nil) -> OauthApplicationCreateAuditEntryQuery {
			addField(field: "organizationUrl", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func rateLimit(aliasSuffix: String? = nil) -> OauthApplicationCreateAuditEntryQuery {
			addField(field: "rateLimit", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func state(aliasSuffix: String? = nil) -> OauthApplicationCreateAuditEntryQuery {
			addField(field: "state", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func user(aliasSuffix: String? = nil, _ subfields: (UserQuery) -> Void) -> OauthApplicationCreateAuditEntryQuery {
		...
		@discardableResult
		open func userLogin(aliasSuffix: String? = nil) -> OauthApplicationCreateAuditEntryQuery {
			addField(field: "userLogin", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func userResourcePath(aliasSuffix: String? = nil) -> OauthApplicationCreateAuditEntryQuery {
			addField(field: "userResourcePath", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func userUrl(aliasSuffix: String? = nil) -> OauthApplicationCreateAuditEntryQuery {
			addField(field: "userUrl", aliasSuffix: aliasSuffix)
			return self
		}
	}

	open class OauthApplicationCreateAuditEntry: GraphQL.AbstractResponse, GraphQLObject, AuditEntry, Node, OauthApplicationAuditEntryData, OrganizationAuditEntry, OrganizationAuditEntryData {
		public typealias Query = OauthApplicationCreateAuditEntryQuery
		...
		open override func deserializeValue(fieldName: String, value: Any) throws -> Any? {
			...
			switch fieldName {
				...
				guard let value = value as? String else {
					throw SchemaViolationError(type: OauthApplicationCreateAuditEntry.self, field: fieldName, value: fieldValue)
				}
				return value
				...
				return OauthApplicationCreateAuditEntryState(rawValue: value) ?? .unknownValue
		...
		open var typeName: String { return "OauthApplicationCreateAuditEntry" }
		...
		open var applicationUrl: String? {
			return internalGetApplicationUrl()
		}

		func internalGetApplicationUrl(aliasSuffix: String? = nil) -> String? {
			return field(field: "applicationUrl", aliasSuffix: aliasSuffix) as! String?
		}

		open var callbackUrl: String? {
			return internalGetCallbackUrl()
		}

		func internalGetCallbackUrl(aliasSuffix: String? = nil) -> String? {
			return field(field: "callbackUrl", aliasSuffix: aliasSuffix) as! String?
		}
		...
		open var rateLimit: Int32? {
			return internalGetRateLimit()
		}

		func internalGetRateLimit(aliasSuffix: String? = nil) -> Int32? {
			return field(field: "rateLimit", aliasSuffix: aliasSuffix) as! Int32?
		}

		open var state: ExampleSchema.OauthApplicationCreateAuditEntryState? {
			return internalGetState()
		}

		func internalGetState(aliasSuffix: String? = nil) -> ExampleSchema.OauthApplicationCreateAuditEntryState? {
			return field(field: "state", aliasSuffix: aliasSuffix) as! ExampleSchema.OauthApplicationCreateAuditEntryState?
		}
