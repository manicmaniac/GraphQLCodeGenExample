...
extension ExampleSchema {
	open class SmimeSignatureQuery: GraphQL.AbstractQuery, GraphQLQuery {
		public typealias Response = SmimeSignature

		@discardableResult
		open func email(aliasSuffix: String? = nil) -> SmimeSignatureQuery {
			addField(field: "email", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func isValid(aliasSuffix: String? = nil) -> SmimeSignatureQuery {
			addField(field: "isValid", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func payload(aliasSuffix: String? = nil) -> SmimeSignatureQuery {
			addField(field: "payload", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func signature(aliasSuffix: String? = nil) -> SmimeSignatureQuery {
			addField(field: "signature", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func signer(aliasSuffix: String? = nil, _ subfields: (UserQuery) -> Void) -> SmimeSignatureQuery {
		...
		@discardableResult
		open func state(aliasSuffix: String? = nil) -> SmimeSignatureQuery {
			addField(field: "state", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func wasSignedByGitHub(aliasSuffix: String? = nil) -> SmimeSignatureQuery {
			addField(field: "wasSignedByGitHub", aliasSuffix: aliasSuffix)
			return self
		}
	}

	open class SmimeSignature: GraphQL.AbstractResponse, GraphQLObject, GitSignature {
		public typealias Query = SmimeSignatureQuery
		...
		open override func deserializeValue(fieldName: String, value: Any) throws -> Any? {
			...
			switch fieldName {
				...
				guard let value = value as? String else {
					throw SchemaViolationError(type: SmimeSignature.self, field: fieldName, value: fieldValue)
				}
				return value
		...
		open var typeName: String { return "SmimeSignature" }
