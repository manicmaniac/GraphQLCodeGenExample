...
extension ExampleSchema {
	open class RegistryPackageStatisticsQuery: GraphQL.AbstractQuery, GraphQLQuery {
		public typealias Response = RegistryPackageStatistics

		@available(*, deprecated, message:"Renaming GitHub Packages fields and objects. Use the `PackageStatistics` object instead. Removal on 2020-04-01 UTC.")
		@discardableResult
		open func downloadsThisMonth(aliasSuffix: String? = nil) -> RegistryPackageStatisticsQuery {
		...
		@available(*, deprecated, message:"Renaming GitHub Packages fields and objects. Use the `PackageStatistics` object instead. Removal on 2020-04-01 UTC.")
		@discardableResult
		open func downloadsThisWeek(aliasSuffix: String? = nil) -> RegistryPackageStatisticsQuery {
		...
		@available(*, deprecated, message:"Renaming GitHub Packages fields and objects. Use the `PackageStatistics` object instead. Removal on 2020-04-01 UTC.")
		@discardableResult
		open func downloadsThisYear(aliasSuffix: String? = nil) -> RegistryPackageStatisticsQuery {
		...
		@available(*, deprecated, message:"Renaming GitHub Packages fields and objects. Use the `PackageStatistics` object instead. Removal on 2020-04-01 UTC.")
		@discardableResult
		open func downloadsToday(aliasSuffix: String? = nil) -> RegistryPackageStatisticsQuery {
		...
		@available(*, deprecated, message:"Renaming GitHub Packages fields and objects. Use the `PackageStatistics` object instead. Removal on 2020-04-01 UTC.")
		@discardableResult
		open func downloadsTotalCount(aliasSuffix: String? = nil) -> RegistryPackageStatisticsQuery {
			addField(field: "downloadsTotalCount", aliasSuffix: aliasSuffix)
			return self
		}
	}

	open class RegistryPackageStatistics: GraphQL.AbstractResponse, GraphQLObject {
		public typealias Query = RegistryPackageStatisticsQuery
		...
		open override func deserializeValue(fieldName: String, value: Any) throws -> Any? {
			...
			switch fieldName {
				...
				guard let value = value as? Int else {
					throw SchemaViolationError(type: RegistryPackageStatistics.self, field: fieldName, value: fieldValue)
				}
				return Int32(value)
		...
		open var typeName: String { return "RegistryPackageStatistics" }
