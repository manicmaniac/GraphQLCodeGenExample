...
extension ExampleSchema {
	open class FollowingConnectionQuery: GraphQL.AbstractQuery, GraphQLQuery {
		public typealias Response = FollowingConnection

		@discardableResult
		open func edges(aliasSuffix: String? = nil, _ subfields: (UserEdgeQuery) -> Void) -> FollowingConnectionQuery {
		...
		@discardableResult
		open func nodes(aliasSuffix: String? = nil, _ subfields: (UserQuery) -> Void) -> FollowingConnectionQuery {
		...
		@discardableResult
		open func pageInfo(aliasSuffix: String? = nil, _ subfields: (PageInfoQuery) -> Void) -> FollowingConnectionQuery {
		...
		@discardableResult
		open func totalCount(aliasSuffix: String? = nil) -> FollowingConnectionQuery {
			addField(field: "totalCount", aliasSuffix: aliasSuffix)
			return self
		}
	}

	open class FollowingConnection: GraphQL.AbstractResponse, GraphQLObject {
		public typealias Query = FollowingConnectionQuery
		...
		open override func deserializeValue(fieldName: String, value: Any) throws -> Any? {
			...
			switch fieldName {
				...
				guard let value = value as? [Any] else {
					throw SchemaViolationError(type: FollowingConnection.self, field: fieldName, value: fieldValue)
				}
		...
		open var typeName: String { return "FollowingConnection" }
