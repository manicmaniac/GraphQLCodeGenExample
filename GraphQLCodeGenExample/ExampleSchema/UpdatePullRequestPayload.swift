...
extension ExampleSchema {
	open class UpdatePullRequestPayloadQuery: GraphQL.AbstractQuery, GraphQLQuery {
		public typealias Response = UpdatePullRequestPayload

		@discardableResult
		open func actor(aliasSuffix: String? = nil, _ subfields: (ActorQuery) -> Void) -> UpdatePullRequestPayloadQuery {
		...
		@discardableResult
		open func clientMutationId(aliasSuffix: String? = nil) -> UpdatePullRequestPayloadQuery {
			addField(field: "clientMutationId", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func pullRequest(aliasSuffix: String? = nil, _ subfields: (PullRequestQuery) -> Void) -> UpdatePullRequestPayloadQuery {
	...
	open class UpdatePullRequestPayload: GraphQL.AbstractResponse, GraphQLObject {
		public typealias Query = UpdatePullRequestPayloadQuery
		...
		open override func deserializeValue(fieldName: String, value: Any) throws -> Any? {
			...
			switch fieldName {
				...
				guard let value = value as? [String: Any] else {
					throw SchemaViolationError(type: UpdatePullRequestPayload.self, field: fieldName, value: fieldValue)
				}
		...
		open var typeName: String { return "UpdatePullRequestPayload" }
