...
extension ExampleSchema {
	open class MilestonedEventQuery: GraphQL.AbstractQuery, GraphQLQuery {
		public typealias Response = MilestonedEvent

		@discardableResult
		open func actor(aliasSuffix: String? = nil, _ subfields: (ActorQuery) -> Void) -> MilestonedEventQuery {
		...
		@discardableResult
		open func createdAt(aliasSuffix: String? = nil) -> MilestonedEventQuery {
			addField(field: "createdAt", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func id(aliasSuffix: String? = nil) -> MilestonedEventQuery {
			addField(field: "id", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func milestoneTitle(aliasSuffix: String? = nil) -> MilestonedEventQuery {
			addField(field: "milestoneTitle", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func subject(aliasSuffix: String? = nil, _ subfields: (MilestoneItemQuery) -> Void) -> MilestonedEventQuery {
	...
	open class MilestonedEvent: GraphQL.AbstractResponse, GraphQLObject, IssueTimelineItem, IssueTimelineItems, Node, PullRequestTimelineItem, PullRequestTimelineItems {
		public typealias Query = MilestonedEventQuery
		...
		open override func deserializeValue(fieldName: String, value: Any) throws -> Any? {
			...
			switch fieldName {
				...
				guard let value = value as? [String: Any] else {
					throw SchemaViolationError(type: MilestonedEvent.self, field: fieldName, value: fieldValue)
				}
		...
		open var typeName: String { return "MilestonedEvent" }
