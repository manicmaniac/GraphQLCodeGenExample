...
extension ExampleSchema {
	open class OrgUpdateMemberRepositoryCreationPermissionAuditEntryQuery: GraphQL.AbstractQuery, GraphQLQuery {
		public typealias Response = OrgUpdateMemberRepositoryCreationPermissionAuditEntry

		@discardableResult
		open func action(aliasSuffix: String? = nil) -> OrgUpdateMemberRepositoryCreationPermissionAuditEntryQuery {
			addField(field: "action", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func actor(aliasSuffix: String? = nil, _ subfields: (AuditEntryActorQuery) -> Void) -> OrgUpdateMemberRepositoryCreationPermissionAuditEntryQuery {
		...
		@discardableResult
		open func actorIp(aliasSuffix: String? = nil) -> OrgUpdateMemberRepositoryCreationPermissionAuditEntryQuery {
			addField(field: "actorIp", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func actorLocation(aliasSuffix: String? = nil, _ subfields: (ActorLocationQuery) -> Void) -> OrgUpdateMemberRepositoryCreationPermissionAuditEntryQuery {
		...
		@discardableResult
		open func actorLogin(aliasSuffix: String? = nil) -> OrgUpdateMemberRepositoryCreationPermissionAuditEntryQuery {
			addField(field: "actorLogin", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func actorResourcePath(aliasSuffix: String? = nil) -> OrgUpdateMemberRepositoryCreationPermissionAuditEntryQuery {
			addField(field: "actorResourcePath", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func actorUrl(aliasSuffix: String? = nil) -> OrgUpdateMemberRepositoryCreationPermissionAuditEntryQuery {
			addField(field: "actorUrl", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func canCreateRepositories(aliasSuffix: String? = nil) -> OrgUpdateMemberRepositoryCreationPermissionAuditEntryQuery {
			addField(field: "canCreateRepositories", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func createdAt(aliasSuffix: String? = nil) -> OrgUpdateMemberRepositoryCreationPermissionAuditEntryQuery {
			addField(field: "createdAt", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func id(aliasSuffix: String? = nil) -> OrgUpdateMemberRepositoryCreationPermissionAuditEntryQuery {
			addField(field: "id", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func operationType(aliasSuffix: String? = nil) -> OrgUpdateMemberRepositoryCreationPermissionAuditEntryQuery {
			addField(field: "operationType", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func organization(aliasSuffix: String? = nil, _ subfields: (OrganizationQuery) -> Void) -> OrgUpdateMemberRepositoryCreationPermissionAuditEntryQuery {
		...
		@discardableResult
		open func organizationName(aliasSuffix: String? = nil) -> OrgUpdateMemberRepositoryCreationPermissionAuditEntryQuery {
			addField(field: "organizationName", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func organizationResourcePath(aliasSuffix: String? = nil) -> OrgUpdateMemberRepositoryCreationPermissionAuditEntryQuery {
			addField(field: "organizationResourcePath", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func organizationUrl(aliasSuffix: String? = nil) -> OrgUpdateMemberRepositoryCreationPermissionAuditEntryQuery {
			addField(field: "organizationUrl", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func user(aliasSuffix: String? = nil, _ subfields: (UserQuery) -> Void) -> OrgUpdateMemberRepositoryCreationPermissionAuditEntryQuery {
		...
		@discardableResult
		open func userLogin(aliasSuffix: String? = nil) -> OrgUpdateMemberRepositoryCreationPermissionAuditEntryQuery {
			addField(field: "userLogin", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func userResourcePath(aliasSuffix: String? = nil) -> OrgUpdateMemberRepositoryCreationPermissionAuditEntryQuery {
			addField(field: "userResourcePath", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func userUrl(aliasSuffix: String? = nil) -> OrgUpdateMemberRepositoryCreationPermissionAuditEntryQuery {
			addField(field: "userUrl", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func visibility(aliasSuffix: String? = nil) -> OrgUpdateMemberRepositoryCreationPermissionAuditEntryQuery {
			addField(field: "visibility", aliasSuffix: aliasSuffix)
			return self
		}
	}

	open class OrgUpdateMemberRepositoryCreationPermissionAuditEntry: GraphQL.AbstractResponse, GraphQLObject, AuditEntry, Node, OrganizationAuditEntry, OrganizationAuditEntryData {
		public typealias Query = OrgUpdateMemberRepositoryCreationPermissionAuditEntryQuery
		...
		open override func deserializeValue(fieldName: String, value: Any) throws -> Any? {
			...
			switch fieldName {
				...
				guard let value = value as? String else {
					throw SchemaViolationError(type: OrgUpdateMemberRepositoryCreationPermissionAuditEntry.self, field: fieldName, value: fieldValue)
				}
				return value
				...
				return OrgUpdateMemberRepositoryCreationPermissionAuditEntryVisibility(rawValue: value) ?? .unknownValue
		...
		open var typeName: String { return "OrgUpdateMemberRepositoryCreationPermissionAuditEntry" }
		...
		open var canCreateRepositories: Bool? {
			return internalGetCanCreateRepositories()
		}

		func internalGetCanCreateRepositories(aliasSuffix: String? = nil) -> Bool? {
			return field(field: "canCreateRepositories", aliasSuffix: aliasSuffix) as! Bool?
		}
		...
		open var visibility: ExampleSchema.OrgUpdateMemberRepositoryCreationPermissionAuditEntryVisibility? {
			return internalGetVisibility()
		}

		func internalGetVisibility(aliasSuffix: String? = nil) -> ExampleSchema.OrgUpdateMemberRepositoryCreationPermissionAuditEntryVisibility? {
			return field(field: "visibility", aliasSuffix: aliasSuffix) as! ExampleSchema.OrgUpdateMemberRepositoryCreationPermissionAuditEntryVisibility?
		}
