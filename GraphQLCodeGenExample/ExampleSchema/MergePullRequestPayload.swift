...
extension ExampleSchema {
	open class MergePullRequestPayloadQuery: GraphQL.AbstractQuery, GraphQLQuery {
		public typealias Response = MergePullRequestPayload

		@discardableResult
		open func actor(aliasSuffix: String? = nil, _ subfields: (ActorQuery) -> Void) -> MergePullRequestPayloadQuery {
		...
		@discardableResult
		open func clientMutationId(aliasSuffix: String? = nil) -> MergePullRequestPayloadQuery {
			addField(field: "clientMutationId", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func pullRequest(aliasSuffix: String? = nil, _ subfields: (PullRequestQuery) -> Void) -> MergePullRequestPayloadQuery {
	...
	open class MergePullRequestPayload: GraphQL.AbstractResponse, GraphQLObject {
		public typealias Query = MergePullRequestPayloadQuery
		...
		open override func deserializeValue(fieldName: String, value: Any) throws -> Any? {
			...
			switch fieldName {
				...
				guard let value = value as? [String: Any] else {
					throw SchemaViolationError(type: MergePullRequestPayload.self, field: fieldName, value: fieldValue)
				}
		...
		open var typeName: String { return "MergePullRequestPayload" }
