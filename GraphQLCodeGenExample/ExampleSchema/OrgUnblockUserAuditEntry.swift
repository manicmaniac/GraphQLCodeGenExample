...
extension ExampleSchema {
	open class OrgUnblockUserAuditEntryQuery: GraphQL.AbstractQuery, GraphQLQuery {
		public typealias Response = OrgUnblockUserAuditEntry

		@discardableResult
		open func action(aliasSuffix: String? = nil) -> OrgUnblockUserAuditEntryQuery {
			addField(field: "action", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func actor(aliasSuffix: String? = nil, _ subfields: (AuditEntryActorQuery) -> Void) -> OrgUnblockUserAuditEntryQuery {
		...
		@discardableResult
		open func actorIp(aliasSuffix: String? = nil) -> OrgUnblockUserAuditEntryQuery {
			addField(field: "actorIp", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func actorLocation(aliasSuffix: String? = nil, _ subfields: (ActorLocationQuery) -> Void) -> OrgUnblockUserAuditEntryQuery {
		...
		@discardableResult
		open func actorLogin(aliasSuffix: String? = nil) -> OrgUnblockUserAuditEntryQuery {
			addField(field: "actorLogin", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func actorResourcePath(aliasSuffix: String? = nil) -> OrgUnblockUserAuditEntryQuery {
			addField(field: "actorResourcePath", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func actorUrl(aliasSuffix: String? = nil) -> OrgUnblockUserAuditEntryQuery {
			addField(field: "actorUrl", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func blockedUser(aliasSuffix: String? = nil, _ subfields: (UserQuery) -> Void) -> OrgUnblockUserAuditEntryQuery {
			let subquery = UserQuery()
			subfields(subquery)

			addField(field: "blockedUser", aliasSuffix: aliasSuffix, subfields: subquery)
			return self
		}

		@discardableResult
		open func blockedUserName(aliasSuffix: String? = nil) -> OrgUnblockUserAuditEntryQuery {
			addField(field: "blockedUserName", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func blockedUserResourcePath(aliasSuffix: String? = nil) -> OrgUnblockUserAuditEntryQuery {
			addField(field: "blockedUserResourcePath", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func blockedUserUrl(aliasSuffix: String? = nil) -> OrgUnblockUserAuditEntryQuery {
			addField(field: "blockedUserUrl", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func createdAt(aliasSuffix: String? = nil) -> OrgUnblockUserAuditEntryQuery {
			addField(field: "createdAt", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func id(aliasSuffix: String? = nil) -> OrgUnblockUserAuditEntryQuery {
			addField(field: "id", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func operationType(aliasSuffix: String? = nil) -> OrgUnblockUserAuditEntryQuery {
			addField(field: "operationType", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func organization(aliasSuffix: String? = nil, _ subfields: (OrganizationQuery) -> Void) -> OrgUnblockUserAuditEntryQuery {
		...
		@discardableResult
		open func organizationName(aliasSuffix: String? = nil) -> OrgUnblockUserAuditEntryQuery {
			addField(field: "organizationName", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func organizationResourcePath(aliasSuffix: String? = nil) -> OrgUnblockUserAuditEntryQuery {
			addField(field: "organizationResourcePath", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func organizationUrl(aliasSuffix: String? = nil) -> OrgUnblockUserAuditEntryQuery {
			addField(field: "organizationUrl", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func user(aliasSuffix: String? = nil, _ subfields: (UserQuery) -> Void) -> OrgUnblockUserAuditEntryQuery {
			let subquery = UserQuery()
			subfields(subquery)
		...
		@discardableResult
		open func userLogin(aliasSuffix: String? = nil) -> OrgUnblockUserAuditEntryQuery {
			addField(field: "userLogin", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func userResourcePath(aliasSuffix: String? = nil) -> OrgUnblockUserAuditEntryQuery {
			addField(field: "userResourcePath", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func userUrl(aliasSuffix: String? = nil) -> OrgUnblockUserAuditEntryQuery {
			addField(field: "userUrl", aliasSuffix: aliasSuffix)
			return self
		}
	}

	open class OrgUnblockUserAuditEntry: GraphQL.AbstractResponse, GraphQLObject, AuditEntry, Node, OrganizationAuditEntry, OrganizationAuditEntryData {
		public typealias Query = OrgUnblockUserAuditEntryQuery
		...
		open override func deserializeValue(fieldName: String, value: Any) throws -> Any? {
			...
			switch fieldName {
				...
				guard let value = value as? String else {
					throw SchemaViolationError(type: OrgUnblockUserAuditEntry.self, field: fieldName, value: fieldValue)
				}
				return value
		...
		open var typeName: String { return "OrgUnblockUserAuditEntry" }
		...
		open var blockedUser: ExampleSchema.User? {
			return internalGetBlockedUser()
		}

		func internalGetBlockedUser(aliasSuffix: String? = nil) -> ExampleSchema.User? {
			return field(field: "blockedUser", aliasSuffix: aliasSuffix) as! ExampleSchema.User?
		}

		open var blockedUserName: String? {
			return internalGetBlockedUserName()
		}

		func internalGetBlockedUserName(aliasSuffix: String? = nil) -> String? {
			return field(field: "blockedUserName", aliasSuffix: aliasSuffix) as! String?
		}

		open var blockedUserResourcePath: String? {
			return internalGetBlockedUserResourcePath()
		}

		func internalGetBlockedUserResourcePath(aliasSuffix: String? = nil) -> String? {
			return field(field: "blockedUserResourcePath", aliasSuffix: aliasSuffix) as! String?
		}

		open var blockedUserUrl: String? {
			return internalGetBlockedUserUrl()
		}

		func internalGetBlockedUserUrl(aliasSuffix: String? = nil) -> String? {
			return field(field: "blockedUserUrl", aliasSuffix: aliasSuffix) as! String?
		}
		...
		open func childResponseObjectMap() -> [GraphQL.AbstractResponse]  {
			...
			objectMap.keys.forEach({
				...
				switch(key) {
					...
					case "blockedUser":
					if let value = internalGetBlockedUser() {
						response.append(value)
						response.append(contentsOf: value.childResponseObjectMap())
					}
