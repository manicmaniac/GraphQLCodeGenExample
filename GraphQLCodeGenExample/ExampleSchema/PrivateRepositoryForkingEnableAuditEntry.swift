...
extension ExampleSchema {
	open class PrivateRepositoryForkingEnableAuditEntryQuery: GraphQL.AbstractQuery, GraphQLQuery {
		public typealias Response = PrivateRepositoryForkingEnableAuditEntry

		@discardableResult
		open func action(aliasSuffix: String? = nil) -> PrivateRepositoryForkingEnableAuditEntryQuery {
			addField(field: "action", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func actor(aliasSuffix: String? = nil, _ subfields: (AuditEntryActorQuery) -> Void) -> PrivateRepositoryForkingEnableAuditEntryQuery {
		...
		@discardableResult
		open func actorIp(aliasSuffix: String? = nil) -> PrivateRepositoryForkingEnableAuditEntryQuery {
			addField(field: "actorIp", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func actorLocation(aliasSuffix: String? = nil, _ subfields: (ActorLocationQuery) -> Void) -> PrivateRepositoryForkingEnableAuditEntryQuery {
		...
		@discardableResult
		open func actorLogin(aliasSuffix: String? = nil) -> PrivateRepositoryForkingEnableAuditEntryQuery {
			addField(field: "actorLogin", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func actorResourcePath(aliasSuffix: String? = nil) -> PrivateRepositoryForkingEnableAuditEntryQuery {
			addField(field: "actorResourcePath", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func actorUrl(aliasSuffix: String? = nil) -> PrivateRepositoryForkingEnableAuditEntryQuery {
			addField(field: "actorUrl", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func createdAt(aliasSuffix: String? = nil) -> PrivateRepositoryForkingEnableAuditEntryQuery {
			addField(field: "createdAt", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func enterpriseResourcePath(aliasSuffix: String? = nil) -> PrivateRepositoryForkingEnableAuditEntryQuery {
			addField(field: "enterpriseResourcePath", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func enterpriseSlug(aliasSuffix: String? = nil) -> PrivateRepositoryForkingEnableAuditEntryQuery {
			addField(field: "enterpriseSlug", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func enterpriseUrl(aliasSuffix: String? = nil) -> PrivateRepositoryForkingEnableAuditEntryQuery {
			addField(field: "enterpriseUrl", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func id(aliasSuffix: String? = nil) -> PrivateRepositoryForkingEnableAuditEntryQuery {
			addField(field: "id", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func operationType(aliasSuffix: String? = nil) -> PrivateRepositoryForkingEnableAuditEntryQuery {
			addField(field: "operationType", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func organization(aliasSuffix: String? = nil, _ subfields: (OrganizationQuery) -> Void) -> PrivateRepositoryForkingEnableAuditEntryQuery {
		...
		@discardableResult
		open func organizationName(aliasSuffix: String? = nil) -> PrivateRepositoryForkingEnableAuditEntryQuery {
			addField(field: "organizationName", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func organizationResourcePath(aliasSuffix: String? = nil) -> PrivateRepositoryForkingEnableAuditEntryQuery {
			addField(field: "organizationResourcePath", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func organizationUrl(aliasSuffix: String? = nil) -> PrivateRepositoryForkingEnableAuditEntryQuery {
			addField(field: "organizationUrl", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func repository(aliasSuffix: String? = nil, _ subfields: (RepositoryQuery) -> Void) -> PrivateRepositoryForkingEnableAuditEntryQuery {
		...
		@discardableResult
		open func repositoryName(aliasSuffix: String? = nil) -> PrivateRepositoryForkingEnableAuditEntryQuery {
			addField(field: "repositoryName", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func repositoryResourcePath(aliasSuffix: String? = nil) -> PrivateRepositoryForkingEnableAuditEntryQuery {
			addField(field: "repositoryResourcePath", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func repositoryUrl(aliasSuffix: String? = nil) -> PrivateRepositoryForkingEnableAuditEntryQuery {
			addField(field: "repositoryUrl", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func user(aliasSuffix: String? = nil, _ subfields: (UserQuery) -> Void) -> PrivateRepositoryForkingEnableAuditEntryQuery {
		...
		@discardableResult
		open func userLogin(aliasSuffix: String? = nil) -> PrivateRepositoryForkingEnableAuditEntryQuery {
			addField(field: "userLogin", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func userResourcePath(aliasSuffix: String? = nil) -> PrivateRepositoryForkingEnableAuditEntryQuery {
			addField(field: "userResourcePath", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func userUrl(aliasSuffix: String? = nil) -> PrivateRepositoryForkingEnableAuditEntryQuery {
			addField(field: "userUrl", aliasSuffix: aliasSuffix)
			return self
		}
	}

	open class PrivateRepositoryForkingEnableAuditEntry: GraphQL.AbstractResponse, GraphQLObject, AuditEntry, EnterpriseAuditEntryData, Node, OrganizationAuditEntry, OrganizationAuditEntryData, RepositoryAuditEntryData {
		public typealias Query = PrivateRepositoryForkingEnableAuditEntryQuery
		...
		open override func deserializeValue(fieldName: String, value: Any) throws -> Any? {
			...
			switch fieldName {
				...
				guard let value = value as? String else {
					throw SchemaViolationError(type: PrivateRepositoryForkingEnableAuditEntry.self, field: fieldName, value: fieldValue)
				}
				return value
		...
		open var typeName: String { return "PrivateRepositoryForkingEnableAuditEntry" }
