...
extension ExampleSchema {
	open class OrgUpdateDefaultRepositoryPermissionAuditEntryQuery: GraphQL.AbstractQuery, GraphQLQuery {
		public typealias Response = OrgUpdateDefaultRepositoryPermissionAuditEntry

		@discardableResult
		open func action(aliasSuffix: String? = nil) -> OrgUpdateDefaultRepositoryPermissionAuditEntryQuery {
			addField(field: "action", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func actor(aliasSuffix: String? = nil, _ subfields: (AuditEntryActorQuery) -> Void) -> OrgUpdateDefaultRepositoryPermissionAuditEntryQuery {
		...
		@discardableResult
		open func actorIp(aliasSuffix: String? = nil) -> OrgUpdateDefaultRepositoryPermissionAuditEntryQuery {
			addField(field: "actorIp", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func actorLocation(aliasSuffix: String? = nil, _ subfields: (ActorLocationQuery) -> Void) -> OrgUpdateDefaultRepositoryPermissionAuditEntryQuery {
		...
		@discardableResult
		open func actorLogin(aliasSuffix: String? = nil) -> OrgUpdateDefaultRepositoryPermissionAuditEntryQuery {
			addField(field: "actorLogin", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func actorResourcePath(aliasSuffix: String? = nil) -> OrgUpdateDefaultRepositoryPermissionAuditEntryQuery {
			addField(field: "actorResourcePath", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func actorUrl(aliasSuffix: String? = nil) -> OrgUpdateDefaultRepositoryPermissionAuditEntryQuery {
			addField(field: "actorUrl", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func createdAt(aliasSuffix: String? = nil) -> OrgUpdateDefaultRepositoryPermissionAuditEntryQuery {
			addField(field: "createdAt", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func id(aliasSuffix: String? = nil) -> OrgUpdateDefaultRepositoryPermissionAuditEntryQuery {
			addField(field: "id", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func operationType(aliasSuffix: String? = nil) -> OrgUpdateDefaultRepositoryPermissionAuditEntryQuery {
			addField(field: "operationType", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func organization(aliasSuffix: String? = nil, _ subfields: (OrganizationQuery) -> Void) -> OrgUpdateDefaultRepositoryPermissionAuditEntryQuery {
		...
		@discardableResult
		open func organizationName(aliasSuffix: String? = nil) -> OrgUpdateDefaultRepositoryPermissionAuditEntryQuery {
			addField(field: "organizationName", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func organizationResourcePath(aliasSuffix: String? = nil) -> OrgUpdateDefaultRepositoryPermissionAuditEntryQuery {
			addField(field: "organizationResourcePath", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func organizationUrl(aliasSuffix: String? = nil) -> OrgUpdateDefaultRepositoryPermissionAuditEntryQuery {
			addField(field: "organizationUrl", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func permission(aliasSuffix: String? = nil) -> OrgUpdateDefaultRepositoryPermissionAuditEntryQuery {
			addField(field: "permission", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func permissionWas(aliasSuffix: String? = nil) -> OrgUpdateDefaultRepositoryPermissionAuditEntryQuery {
			addField(field: "permissionWas", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func user(aliasSuffix: String? = nil, _ subfields: (UserQuery) -> Void) -> OrgUpdateDefaultRepositoryPermissionAuditEntryQuery {
		...
		@discardableResult
		open func userLogin(aliasSuffix: String? = nil) -> OrgUpdateDefaultRepositoryPermissionAuditEntryQuery {
			addField(field: "userLogin", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func userResourcePath(aliasSuffix: String? = nil) -> OrgUpdateDefaultRepositoryPermissionAuditEntryQuery {
			addField(field: "userResourcePath", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func userUrl(aliasSuffix: String? = nil) -> OrgUpdateDefaultRepositoryPermissionAuditEntryQuery {
			addField(field: "userUrl", aliasSuffix: aliasSuffix)
			return self
		}
	}

	open class OrgUpdateDefaultRepositoryPermissionAuditEntry: GraphQL.AbstractResponse, GraphQLObject, AuditEntry, Node, OrganizationAuditEntry, OrganizationAuditEntryData {
		public typealias Query = OrgUpdateDefaultRepositoryPermissionAuditEntryQuery
		...
		open override func deserializeValue(fieldName: String, value: Any) throws -> Any? {
			...
			switch fieldName {
				...
				guard let value = value as? String else {
					throw SchemaViolationError(type: OrgUpdateDefaultRepositoryPermissionAuditEntry.self, field: fieldName, value: fieldValue)
				}
				return value
				...
				return OrgUpdateDefaultRepositoryPermissionAuditEntryPermission(rawValue: value) ?? .unknownValue
		...
		open var typeName: String { return "OrgUpdateDefaultRepositoryPermissionAuditEntry" }
		...
		open var permission: ExampleSchema.OrgUpdateDefaultRepositoryPermissionAuditEntryPermission? {
			return internalGetPermission()
		}

		func internalGetPermission(aliasSuffix: String? = nil) -> ExampleSchema.OrgUpdateDefaultRepositoryPermissionAuditEntryPermission? {
			return field(field: "permission", aliasSuffix: aliasSuffix) as! ExampleSchema.OrgUpdateDefaultRepositoryPermissionAuditEntryPermission?
		}

		open var permissionWas: ExampleSchema.OrgUpdateDefaultRepositoryPermissionAuditEntryPermission? {
			return internalGetPermissionWas()
		}

		func internalGetPermissionWas(aliasSuffix: String? = nil) -> ExampleSchema.OrgUpdateDefaultRepositoryPermissionAuditEntryPermission? {
			return field(field: "permissionWas", aliasSuffix: aliasSuffix) as! ExampleSchema.OrgUpdateDefaultRepositoryPermissionAuditEntryPermission?
		}
