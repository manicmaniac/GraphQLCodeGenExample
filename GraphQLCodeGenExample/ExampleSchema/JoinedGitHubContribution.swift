...
extension ExampleSchema {
	open class JoinedGitHubContributionQuery: GraphQL.AbstractQuery, GraphQLQuery {
		public typealias Response = JoinedGitHubContribution

		@discardableResult
		open func isRestricted(aliasSuffix: String? = nil) -> JoinedGitHubContributionQuery {
			addField(field: "isRestricted", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func occurredAt(aliasSuffix: String? = nil) -> JoinedGitHubContributionQuery {
			addField(field: "occurredAt", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func resourcePath(aliasSuffix: String? = nil) -> JoinedGitHubContributionQuery {
			addField(field: "resourcePath", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func url(aliasSuffix: String? = nil) -> JoinedGitHubContributionQuery {
			addField(field: "url", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func user(aliasSuffix: String? = nil, _ subfields: (UserQuery) -> Void) -> JoinedGitHubContributionQuery {
	...
	open class JoinedGitHubContribution: GraphQL.AbstractResponse, GraphQLObject, Contribution {
		public typealias Query = JoinedGitHubContributionQuery
		...
		open override func deserializeValue(fieldName: String, value: Any) throws -> Any? {
			...
			switch fieldName {
				...
				guard let value = value as? Bool else {
					throw SchemaViolationError(type: JoinedGitHubContribution.self, field: fieldName, value: fieldValue)
				}
				return value
		...
		open var typeName: String { return "JoinedGitHubContribution" }
