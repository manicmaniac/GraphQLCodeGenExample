...
extension ExampleSchema {
	open class EnterprisePendingCollaboratorEdgeQuery: GraphQL.AbstractQuery, GraphQLQuery {
		public typealias Response = EnterprisePendingCollaboratorEdge

		@discardableResult
		open func cursor(aliasSuffix: String? = nil) -> EnterprisePendingCollaboratorEdgeQuery {
			addField(field: "cursor", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func isUnlicensed(aliasSuffix: String? = nil) -> EnterprisePendingCollaboratorEdgeQuery {
			addField(field: "isUnlicensed", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func node(aliasSuffix: String? = nil, _ subfields: (UserQuery) -> Void) -> EnterprisePendingCollaboratorEdgeQuery {
		...
		@discardableResult
		open func repositories(aliasSuffix: String? = nil, after: String? = nil, before: String? = nil, first: Int32? = nil, last: Int32? = nil, orderBy: RepositoryOrder? = nil, _ subfields: (EnterpriseRepositoryInfoConnectionQuery) -> Void) -> EnterprisePendingCollaboratorEdgeQuery {
			var args: [String] = []
	...
	open class EnterprisePendingCollaboratorEdge: GraphQL.AbstractResponse, GraphQLObject {
		public typealias Query = EnterprisePendingCollaboratorEdgeQuery
		...
		open override func deserializeValue(fieldName: String, value: Any) throws -> Any? {
			...
			switch fieldName {
				...
				guard let value = value as? String else {
					throw SchemaViolationError(type: EnterprisePendingCollaboratorEdge.self, field: fieldName, value: fieldValue)
				}
				return value
		...
		open var typeName: String { return "EnterprisePendingCollaboratorEdge" }
