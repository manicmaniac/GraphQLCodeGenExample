...
extension ExampleSchema {
	open class TeamRemoveRepositoryAuditEntryQuery: GraphQL.AbstractQuery, GraphQLQuery {
		public typealias Response = TeamRemoveRepositoryAuditEntry

		@discardableResult
		open func action(aliasSuffix: String? = nil) -> TeamRemoveRepositoryAuditEntryQuery {
			addField(field: "action", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func actor(aliasSuffix: String? = nil, _ subfields: (AuditEntryActorQuery) -> Void) -> TeamRemoveRepositoryAuditEntryQuery {
		...
		@discardableResult
		open func actorIp(aliasSuffix: String? = nil) -> TeamRemoveRepositoryAuditEntryQuery {
			addField(field: "actorIp", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func actorLocation(aliasSuffix: String? = nil, _ subfields: (ActorLocationQuery) -> Void) -> TeamRemoveRepositoryAuditEntryQuery {
		...
		@discardableResult
		open func actorLogin(aliasSuffix: String? = nil) -> TeamRemoveRepositoryAuditEntryQuery {
			addField(field: "actorLogin", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func actorResourcePath(aliasSuffix: String? = nil) -> TeamRemoveRepositoryAuditEntryQuery {
			addField(field: "actorResourcePath", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func actorUrl(aliasSuffix: String? = nil) -> TeamRemoveRepositoryAuditEntryQuery {
			addField(field: "actorUrl", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func createdAt(aliasSuffix: String? = nil) -> TeamRemoveRepositoryAuditEntryQuery {
			addField(field: "createdAt", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func id(aliasSuffix: String? = nil) -> TeamRemoveRepositoryAuditEntryQuery {
			addField(field: "id", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func isLdapMapped(aliasSuffix: String? = nil) -> TeamRemoveRepositoryAuditEntryQuery {
			addField(field: "isLdapMapped", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func operationType(aliasSuffix: String? = nil) -> TeamRemoveRepositoryAuditEntryQuery {
			addField(field: "operationType", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func organization(aliasSuffix: String? = nil, _ subfields: (OrganizationQuery) -> Void) -> TeamRemoveRepositoryAuditEntryQuery {
		...
		@discardableResult
		open func organizationName(aliasSuffix: String? = nil) -> TeamRemoveRepositoryAuditEntryQuery {
			addField(field: "organizationName", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func organizationResourcePath(aliasSuffix: String? = nil) -> TeamRemoveRepositoryAuditEntryQuery {
			addField(field: "organizationResourcePath", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func organizationUrl(aliasSuffix: String? = nil) -> TeamRemoveRepositoryAuditEntryQuery {
			addField(field: "organizationUrl", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func repository(aliasSuffix: String? = nil, _ subfields: (RepositoryQuery) -> Void) -> TeamRemoveRepositoryAuditEntryQuery {
		...
		@discardableResult
		open func repositoryName(aliasSuffix: String? = nil) -> TeamRemoveRepositoryAuditEntryQuery {
			addField(field: "repositoryName", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func repositoryResourcePath(aliasSuffix: String? = nil) -> TeamRemoveRepositoryAuditEntryQuery {
			addField(field: "repositoryResourcePath", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func repositoryUrl(aliasSuffix: String? = nil) -> TeamRemoveRepositoryAuditEntryQuery {
			addField(field: "repositoryUrl", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func team(aliasSuffix: String? = nil, _ subfields: (TeamQuery) -> Void) -> TeamRemoveRepositoryAuditEntryQuery {
		...
		@discardableResult
		open func teamName(aliasSuffix: String? = nil) -> TeamRemoveRepositoryAuditEntryQuery {
			addField(field: "teamName", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func teamResourcePath(aliasSuffix: String? = nil) -> TeamRemoveRepositoryAuditEntryQuery {
			addField(field: "teamResourcePath", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func teamUrl(aliasSuffix: String? = nil) -> TeamRemoveRepositoryAuditEntryQuery {
			addField(field: "teamUrl", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func user(aliasSuffix: String? = nil, _ subfields: (UserQuery) -> Void) -> TeamRemoveRepositoryAuditEntryQuery {
		...
		@discardableResult
		open func userLogin(aliasSuffix: String? = nil) -> TeamRemoveRepositoryAuditEntryQuery {
			addField(field: "userLogin", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func userResourcePath(aliasSuffix: String? = nil) -> TeamRemoveRepositoryAuditEntryQuery {
			addField(field: "userResourcePath", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func userUrl(aliasSuffix: String? = nil) -> TeamRemoveRepositoryAuditEntryQuery {
			addField(field: "userUrl", aliasSuffix: aliasSuffix)
			return self
		}
	}

	open class TeamRemoveRepositoryAuditEntry: GraphQL.AbstractResponse, GraphQLObject, AuditEntry, Node, OrganizationAuditEntry, OrganizationAuditEntryData, RepositoryAuditEntryData, TeamAuditEntryData {
		public typealias Query = TeamRemoveRepositoryAuditEntryQuery
		...
		open override func deserializeValue(fieldName: String, value: Any) throws -> Any? {
			...
			switch fieldName {
				...
				guard let value = value as? String else {
					throw SchemaViolationError(type: TeamRemoveRepositoryAuditEntry.self, field: fieldName, value: fieldValue)
				}
				return value
		...
		open var typeName: String { return "TeamRemoveRepositoryAuditEntry" }
