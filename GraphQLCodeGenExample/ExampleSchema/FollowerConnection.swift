...
extension ExampleSchema {
	open class FollowerConnectionQuery: GraphQL.AbstractQuery, GraphQLQuery {
		public typealias Response = FollowerConnection

		@discardableResult
		open func edges(aliasSuffix: String? = nil, _ subfields: (UserEdgeQuery) -> Void) -> FollowerConnectionQuery {
		...
		@discardableResult
		open func nodes(aliasSuffix: String? = nil, _ subfields: (UserQuery) -> Void) -> FollowerConnectionQuery {
		...
		@discardableResult
		open func pageInfo(aliasSuffix: String? = nil, _ subfields: (PageInfoQuery) -> Void) -> FollowerConnectionQuery {
		...
		@discardableResult
		open func totalCount(aliasSuffix: String? = nil) -> FollowerConnectionQuery {
			addField(field: "totalCount", aliasSuffix: aliasSuffix)
			return self
		}
	}

	open class FollowerConnection: GraphQL.AbstractResponse, GraphQLObject {
		public typealias Query = FollowerConnectionQuery
		...
		open override func deserializeValue(fieldName: String, value: Any) throws -> Any? {
			...
			switch fieldName {
				...
				guard let value = value as? [Any] else {
					throw SchemaViolationError(type: FollowerConnection.self, field: fieldName, value: fieldValue)
				}
		...
		open var typeName: String { return "FollowerConnection" }
