...
extension ExampleSchema {
	open class RepoConfigDisableSockpuppetDisallowedAuditEntryQuery: GraphQL.AbstractQuery, GraphQLQuery {
		public typealias Response = RepoConfigDisableSockpuppetDisallowedAuditEntry

		@discardableResult
		open func action(aliasSuffix: String? = nil) -> RepoConfigDisableSockpuppetDisallowedAuditEntryQuery {
			addField(field: "action", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func actor(aliasSuffix: String? = nil, _ subfields: (AuditEntryActorQuery) -> Void) -> RepoConfigDisableSockpuppetDisallowedAuditEntryQuery {
		...
		@discardableResult
		open func actorIp(aliasSuffix: String? = nil) -> RepoConfigDisableSockpuppetDisallowedAuditEntryQuery {
			addField(field: "actorIp", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func actorLocation(aliasSuffix: String? = nil, _ subfields: (ActorLocationQuery) -> Void) -> RepoConfigDisableSockpuppetDisallowedAuditEntryQuery {
		...
		@discardableResult
		open func actorLogin(aliasSuffix: String? = nil) -> RepoConfigDisableSockpuppetDisallowedAuditEntryQuery {
			addField(field: "actorLogin", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func actorResourcePath(aliasSuffix: String? = nil) -> RepoConfigDisableSockpuppetDisallowedAuditEntryQuery {
			addField(field: "actorResourcePath", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func actorUrl(aliasSuffix: String? = nil) -> RepoConfigDisableSockpuppetDisallowedAuditEntryQuery {
			addField(field: "actorUrl", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func createdAt(aliasSuffix: String? = nil) -> RepoConfigDisableSockpuppetDisallowedAuditEntryQuery {
			addField(field: "createdAt", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func id(aliasSuffix: String? = nil) -> RepoConfigDisableSockpuppetDisallowedAuditEntryQuery {
			addField(field: "id", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func operationType(aliasSuffix: String? = nil) -> RepoConfigDisableSockpuppetDisallowedAuditEntryQuery {
			addField(field: "operationType", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func organization(aliasSuffix: String? = nil, _ subfields: (OrganizationQuery) -> Void) -> RepoConfigDisableSockpuppetDisallowedAuditEntryQuery {
		...
		@discardableResult
		open func organizationName(aliasSuffix: String? = nil) -> RepoConfigDisableSockpuppetDisallowedAuditEntryQuery {
			addField(field: "organizationName", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func organizationResourcePath(aliasSuffix: String? = nil) -> RepoConfigDisableSockpuppetDisallowedAuditEntryQuery {
			addField(field: "organizationResourcePath", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func organizationUrl(aliasSuffix: String? = nil) -> RepoConfigDisableSockpuppetDisallowedAuditEntryQuery {
			addField(field: "organizationUrl", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func repository(aliasSuffix: String? = nil, _ subfields: (RepositoryQuery) -> Void) -> RepoConfigDisableSockpuppetDisallowedAuditEntryQuery {
		...
		@discardableResult
		open func repositoryName(aliasSuffix: String? = nil) -> RepoConfigDisableSockpuppetDisallowedAuditEntryQuery {
			addField(field: "repositoryName", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func repositoryResourcePath(aliasSuffix: String? = nil) -> RepoConfigDisableSockpuppetDisallowedAuditEntryQuery {
			addField(field: "repositoryResourcePath", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func repositoryUrl(aliasSuffix: String? = nil) -> RepoConfigDisableSockpuppetDisallowedAuditEntryQuery {
			addField(field: "repositoryUrl", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func user(aliasSuffix: String? = nil, _ subfields: (UserQuery) -> Void) -> RepoConfigDisableSockpuppetDisallowedAuditEntryQuery {
		...
		@discardableResult
		open func userLogin(aliasSuffix: String? = nil) -> RepoConfigDisableSockpuppetDisallowedAuditEntryQuery {
			addField(field: "userLogin", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func userResourcePath(aliasSuffix: String? = nil) -> RepoConfigDisableSockpuppetDisallowedAuditEntryQuery {
			addField(field: "userResourcePath", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func userUrl(aliasSuffix: String? = nil) -> RepoConfigDisableSockpuppetDisallowedAuditEntryQuery {
			addField(field: "userUrl", aliasSuffix: aliasSuffix)
			return self
		}
	}

	open class RepoConfigDisableSockpuppetDisallowedAuditEntry: GraphQL.AbstractResponse, GraphQLObject, AuditEntry, Node, OrganizationAuditEntry, OrganizationAuditEntryData, RepositoryAuditEntryData {
		public typealias Query = RepoConfigDisableSockpuppetDisallowedAuditEntryQuery
		...
		open override func deserializeValue(fieldName: String, value: Any) throws -> Any? {
			...
			switch fieldName {
				...
				guard let value = value as? String else {
					throw SchemaViolationError(type: RepoConfigDisableSockpuppetDisallowedAuditEntry.self, field: fieldName, value: fieldValue)
				}
				return value
		...
		open var typeName: String { return "RepoConfigDisableSockpuppetDisallowedAuditEntry" }
