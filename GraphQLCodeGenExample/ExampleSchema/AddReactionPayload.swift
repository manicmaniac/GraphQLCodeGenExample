...
extension ExampleSchema {
	open class AddReactionPayloadQuery: GraphQL.AbstractQuery, GraphQLQuery {
		public typealias Response = AddReactionPayload

		@discardableResult
		open func clientMutationId(aliasSuffix: String? = nil) -> AddReactionPayloadQuery {
			addField(field: "clientMutationId", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func reaction(aliasSuffix: String? = nil, _ subfields: (ReactionQuery) -> Void) -> AddReactionPayloadQuery {
		...
		@discardableResult
		open func subject(aliasSuffix: String? = nil, _ subfields: (ReactableQuery) -> Void) -> AddReactionPayloadQuery {
	...
	open class AddReactionPayload: GraphQL.AbstractResponse, GraphQLObject {
		public typealias Query = AddReactionPayloadQuery
		...
		open override func deserializeValue(fieldName: String, value: Any) throws -> Any? {
			...
			switch fieldName {
				...
				guard let value = value as? String else {
					throw SchemaViolationError(type: AddReactionPayload.self, field: fieldName, value: fieldValue)
				}
				return value
		...
		open var typeName: String { return "AddReactionPayload" }
