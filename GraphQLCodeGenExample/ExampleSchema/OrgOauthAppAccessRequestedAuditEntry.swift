...
extension ExampleSchema {
	open class OrgOauthAppAccessRequestedAuditEntryQuery: GraphQL.AbstractQuery, GraphQLQuery {
		public typealias Response = OrgOauthAppAccessRequestedAuditEntry

		@discardableResult
		open func action(aliasSuffix: String? = nil) -> OrgOauthAppAccessRequestedAuditEntryQuery {
			addField(field: "action", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func actor(aliasSuffix: String? = nil, _ subfields: (AuditEntryActorQuery) -> Void) -> OrgOauthAppAccessRequestedAuditEntryQuery {
		...
		@discardableResult
		open func actorIp(aliasSuffix: String? = nil) -> OrgOauthAppAccessRequestedAuditEntryQuery {
			addField(field: "actorIp", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func actorLocation(aliasSuffix: String? = nil, _ subfields: (ActorLocationQuery) -> Void) -> OrgOauthAppAccessRequestedAuditEntryQuery {
		...
		@discardableResult
		open func actorLogin(aliasSuffix: String? = nil) -> OrgOauthAppAccessRequestedAuditEntryQuery {
			addField(field: "actorLogin", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func actorResourcePath(aliasSuffix: String? = nil) -> OrgOauthAppAccessRequestedAuditEntryQuery {
			addField(field: "actorResourcePath", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func actorUrl(aliasSuffix: String? = nil) -> OrgOauthAppAccessRequestedAuditEntryQuery {
			addField(field: "actorUrl", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func createdAt(aliasSuffix: String? = nil) -> OrgOauthAppAccessRequestedAuditEntryQuery {
			addField(field: "createdAt", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func id(aliasSuffix: String? = nil) -> OrgOauthAppAccessRequestedAuditEntryQuery {
			addField(field: "id", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func oauthApplicationName(aliasSuffix: String? = nil) -> OrgOauthAppAccessRequestedAuditEntryQuery {
			addField(field: "oauthApplicationName", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func oauthApplicationResourcePath(aliasSuffix: String? = nil) -> OrgOauthAppAccessRequestedAuditEntryQuery {
			addField(field: "oauthApplicationResourcePath", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func oauthApplicationUrl(aliasSuffix: String? = nil) -> OrgOauthAppAccessRequestedAuditEntryQuery {
			addField(field: "oauthApplicationUrl", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func operationType(aliasSuffix: String? = nil) -> OrgOauthAppAccessRequestedAuditEntryQuery {
			addField(field: "operationType", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func organization(aliasSuffix: String? = nil, _ subfields: (OrganizationQuery) -> Void) -> OrgOauthAppAccessRequestedAuditEntryQuery {
		...
		@discardableResult
		open func organizationName(aliasSuffix: String? = nil) -> OrgOauthAppAccessRequestedAuditEntryQuery {
			addField(field: "organizationName", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func organizationResourcePath(aliasSuffix: String? = nil) -> OrgOauthAppAccessRequestedAuditEntryQuery {
			addField(field: "organizationResourcePath", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func organizationUrl(aliasSuffix: String? = nil) -> OrgOauthAppAccessRequestedAuditEntryQuery {
			addField(field: "organizationUrl", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func user(aliasSuffix: String? = nil, _ subfields: (UserQuery) -> Void) -> OrgOauthAppAccessRequestedAuditEntryQuery {
		...
		@discardableResult
		open func userLogin(aliasSuffix: String? = nil) -> OrgOauthAppAccessRequestedAuditEntryQuery {
			addField(field: "userLogin", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func userResourcePath(aliasSuffix: String? = nil) -> OrgOauthAppAccessRequestedAuditEntryQuery {
			addField(field: "userResourcePath", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func userUrl(aliasSuffix: String? = nil) -> OrgOauthAppAccessRequestedAuditEntryQuery {
			addField(field: "userUrl", aliasSuffix: aliasSuffix)
			return self
		}
	}

	open class OrgOauthAppAccessRequestedAuditEntry: GraphQL.AbstractResponse, GraphQLObject, AuditEntry, Node, OauthApplicationAuditEntryData, OrganizationAuditEntry, OrganizationAuditEntryData {
		public typealias Query = OrgOauthAppAccessRequestedAuditEntryQuery
		...
		open override func deserializeValue(fieldName: String, value: Any) throws -> Any? {
			...
			switch fieldName {
				...
				guard let value = value as? String else {
					throw SchemaViolationError(type: OrgOauthAppAccessRequestedAuditEntry.self, field: fieldName, value: fieldValue)
				}
				return value
		...
		open var typeName: String { return "OrgOauthAppAccessRequestedAuditEntry" }
