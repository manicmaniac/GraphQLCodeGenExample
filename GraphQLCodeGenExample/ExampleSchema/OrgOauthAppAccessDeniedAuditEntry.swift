...
extension ExampleSchema {
	open class OrgOauthAppAccessDeniedAuditEntryQuery: GraphQL.AbstractQuery, GraphQLQuery {
		public typealias Response = OrgOauthAppAccessDeniedAuditEntry

		@discardableResult
		open func action(aliasSuffix: String? = nil) -> OrgOauthAppAccessDeniedAuditEntryQuery {
			addField(field: "action", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func actor(aliasSuffix: String? = nil, _ subfields: (AuditEntryActorQuery) -> Void) -> OrgOauthAppAccessDeniedAuditEntryQuery {
		...
		@discardableResult
		open func actorIp(aliasSuffix: String? = nil) -> OrgOauthAppAccessDeniedAuditEntryQuery {
			addField(field: "actorIp", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func actorLocation(aliasSuffix: String? = nil, _ subfields: (ActorLocationQuery) -> Void) -> OrgOauthAppAccessDeniedAuditEntryQuery {
		...
		@discardableResult
		open func actorLogin(aliasSuffix: String? = nil) -> OrgOauthAppAccessDeniedAuditEntryQuery {
			addField(field: "actorLogin", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func actorResourcePath(aliasSuffix: String? = nil) -> OrgOauthAppAccessDeniedAuditEntryQuery {
			addField(field: "actorResourcePath", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func actorUrl(aliasSuffix: String? = nil) -> OrgOauthAppAccessDeniedAuditEntryQuery {
			addField(field: "actorUrl", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func createdAt(aliasSuffix: String? = nil) -> OrgOauthAppAccessDeniedAuditEntryQuery {
			addField(field: "createdAt", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func id(aliasSuffix: String? = nil) -> OrgOauthAppAccessDeniedAuditEntryQuery {
			addField(field: "id", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func oauthApplicationName(aliasSuffix: String? = nil) -> OrgOauthAppAccessDeniedAuditEntryQuery {
			addField(field: "oauthApplicationName", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func oauthApplicationResourcePath(aliasSuffix: String? = nil) -> OrgOauthAppAccessDeniedAuditEntryQuery {
			addField(field: "oauthApplicationResourcePath", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func oauthApplicationUrl(aliasSuffix: String? = nil) -> OrgOauthAppAccessDeniedAuditEntryQuery {
			addField(field: "oauthApplicationUrl", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func operationType(aliasSuffix: String? = nil) -> OrgOauthAppAccessDeniedAuditEntryQuery {
			addField(field: "operationType", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func organization(aliasSuffix: String? = nil, _ subfields: (OrganizationQuery) -> Void) -> OrgOauthAppAccessDeniedAuditEntryQuery {
		...
		@discardableResult
		open func organizationName(aliasSuffix: String? = nil) -> OrgOauthAppAccessDeniedAuditEntryQuery {
			addField(field: "organizationName", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func organizationResourcePath(aliasSuffix: String? = nil) -> OrgOauthAppAccessDeniedAuditEntryQuery {
			addField(field: "organizationResourcePath", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func organizationUrl(aliasSuffix: String? = nil) -> OrgOauthAppAccessDeniedAuditEntryQuery {
			addField(field: "organizationUrl", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func user(aliasSuffix: String? = nil, _ subfields: (UserQuery) -> Void) -> OrgOauthAppAccessDeniedAuditEntryQuery {
		...
		@discardableResult
		open func userLogin(aliasSuffix: String? = nil) -> OrgOauthAppAccessDeniedAuditEntryQuery {
			addField(field: "userLogin", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func userResourcePath(aliasSuffix: String? = nil) -> OrgOauthAppAccessDeniedAuditEntryQuery {
			addField(field: "userResourcePath", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func userUrl(aliasSuffix: String? = nil) -> OrgOauthAppAccessDeniedAuditEntryQuery {
			addField(field: "userUrl", aliasSuffix: aliasSuffix)
			return self
		}
	}

	open class OrgOauthAppAccessDeniedAuditEntry: GraphQL.AbstractResponse, GraphQLObject, AuditEntry, Node, OauthApplicationAuditEntryData, OrganizationAuditEntry, OrganizationAuditEntryData {
		public typealias Query = OrgOauthAppAccessDeniedAuditEntryQuery
		...
		open override func deserializeValue(fieldName: String, value: Any) throws -> Any? {
			...
			switch fieldName {
				...
				guard let value = value as? String else {
					throw SchemaViolationError(type: OrgOauthAppAccessDeniedAuditEntry.self, field: fieldName, value: fieldValue)
				}
				return value
		...
		open var typeName: String { return "OrgOauthAppAccessDeniedAuditEntry" }
