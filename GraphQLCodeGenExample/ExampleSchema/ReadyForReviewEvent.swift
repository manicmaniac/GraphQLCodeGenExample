...
extension ExampleSchema {
	open class ReadyForReviewEventQuery: GraphQL.AbstractQuery, GraphQLQuery {
		public typealias Response = ReadyForReviewEvent

		@discardableResult
		open func actor(aliasSuffix: String? = nil, _ subfields: (ActorQuery) -> Void) -> ReadyForReviewEventQuery {
		...
		@discardableResult
		open func createdAt(aliasSuffix: String? = nil) -> ReadyForReviewEventQuery {
			addField(field: "createdAt", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func id(aliasSuffix: String? = nil) -> ReadyForReviewEventQuery {
			addField(field: "id", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func pullRequest(aliasSuffix: String? = nil, _ subfields: (PullRequestQuery) -> Void) -> ReadyForReviewEventQuery {
		...
		@discardableResult
		open func resourcePath(aliasSuffix: String? = nil) -> ReadyForReviewEventQuery {
			addField(field: "resourcePath", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func url(aliasSuffix: String? = nil) -> ReadyForReviewEventQuery {
			addField(field: "url", aliasSuffix: aliasSuffix)
			return self
		}
	}

	open class ReadyForReviewEvent: GraphQL.AbstractResponse, GraphQLObject, Node, PullRequestTimelineItems, UniformResourceLocatable {
		public typealias Query = ReadyForReviewEventQuery
		...
		open override func deserializeValue(fieldName: String, value: Any) throws -> Any? {
			...
			switch fieldName {
				...
				guard let value = value as? [String: Any] else {
					throw SchemaViolationError(type: ReadyForReviewEvent.self, field: fieldName, value: fieldValue)
				}
		...
		open var typeName: String { return "ReadyForReviewEvent" }
